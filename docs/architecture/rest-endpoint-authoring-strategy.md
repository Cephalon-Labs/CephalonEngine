...
- the next shorthand metadata-and-document truthfulness follow-through is now shipped through
  ...
  `ENG-058-T111`, `ENG-058-T112`, and `ENG-058-T113`: same-value endpoint-metadata, tag, and document-name rewrites plus reorder-only
  ...
  whenever the runtime candidate registry is active
