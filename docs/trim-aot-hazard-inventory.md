...
**Update May 5, 2026 (`ENG-430`):** the manifest contract tests now drift-protect the inventory ↔ manifest seeding at the path-truth layer. Three new Pester `It` cases lift the suite from 28 → 31:
