...
- [ ] `EventingOperationalSuperiorityEvidence` from `scripts/eventing-operational-superiority-support.json` includes native Eventing promotion contract/status/dimension/coverage/hot-path/Wolverine readback, and release validation plus optional `cephalon doctor --scorecard` agree ✅
...
- [ ] `EventingOperationalSuperiorityEvidence` matches the Eventing operational-superiority support manifest, keeps hot-path publish/subscription code-first, and keeps Wolverine optional
