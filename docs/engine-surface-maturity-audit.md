...
- treat `Engine:Messaging:Channels` / `Engine:Messaging:Subscriptions` as configuration-owned descriptor discovery and override proof, not handler auto-registration or broker topology ownership
