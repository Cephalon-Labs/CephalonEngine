...
Surface maturity in this document reflects the repository state as of `May 3, 2026` (post-`ENG-371` Cephalon.Eventing OTel adapter activity emission).
