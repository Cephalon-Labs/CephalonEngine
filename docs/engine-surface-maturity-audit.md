...
Surface maturity in this document reflects the repository state as of `May 4, 2026` (post-`ENG-401` Cephalon.Agentics OTel adapter activity emission).
