...
This is a bounded consumer proof, not a complete API-diff service. All-package API validation, runtime snapshots, host configuration, generated apps, provider migrations and trim/Native AOT/single-file claims remain outside this fixture. Newly added APIs are explicitly **not** safe to downgrade to an older contract assembly. The separate [host matrix](host-compatibility-2026-09.md) completes ENG-744 and the declared ENG-742/731 acceptance; the exclusions of this seven-scenario fixture remain unchanged.
