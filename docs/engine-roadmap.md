...
- retry with exponential backoff and jitter plus idempotency-aware failure classification over the existing timeout/circuit-breaker/bulkhead pipeline
