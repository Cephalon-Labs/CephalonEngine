...
2. broader release automation and package-publishing polish only when an explicit package-distribution, provenance, or install-surface scenario appears beyond the shipped `ENG-030` package-artifact baseline
