...
- the remaining phase-10 work is now broader provider consumption, broader role graphs beyond `UseRole -> write`, live role health and migration-execution diagnostics, dedicated outbox execution, bundle/script orchestration guidance, and replay follow-through plus richer export formats for durable history
