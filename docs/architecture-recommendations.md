...
- Built-in GraphQL resolver/subscription execution resilience beyond endpoint rate limiting and behavior-dispatch bindings
- Provider-specific non-REST transport adapters that need their own native fault envelopes beyond the ASP.NET Core direct gRPC, JSON-RPC, SSE, and WebSocket baselines
