...
- later follow-through: compensation helpers only when they can remain additive over the shared replay contract instead of becoming a second workflow engine hidden inside `Cephalon.Behaviors`
