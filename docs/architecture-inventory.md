...
- `MailgunInvitationDeliveryStatusCallbackResult` / `MailgunInvitationDeliveryStatusCallbackEventResult` — aggregate and per-event response contracts for accepted and skipped Mailgun webhook translation in `Cephalon.MultiTenancy.Governance.MailgunDelivery.AspNetCore`
...
- `tenant-invitation-delivery-mailgun-status-callbacks` technology surface — ASP.NET Core Mailgun webhook translator posture from `Cephalon.MultiTenancy.Governance.MailgunDelivery.AspNetCore`
...
- Multi-Tenancy Governance Mailgun Delivery ASP.NET Core (`Cephalon.MultiTenancy.Governance.MailgunDelivery.AspNetCore`) — event ID 4568
...
- `Cephalon.MultiTenancy.Governance.MailgunDelivery.AspNetCore` — ASP.NET Core Mailgun webhook translator for tenant-invitation delivery-status reconciliation
