...
| #3 — Trim, AOT, and single-file claim story is still not closed | `partial` | `ENG-426`, `ENG-427`, `ENG-431`..`ENG-439`, `ENG-449`, `ENG-454`, `ENG-455`, `ENG-456`, `ENG-457`, `ENG-458`, `ENG-459`, `ENG-460`, `ENG-461`, `ENG-462`, `ENG-463`, `ENG-464`, `ENG-465`, `ENG-466`, `ENG-467`, `ENG-468`, `ENG-469`, `ENG-470`, `ENG-471`, `ENG-472`, `ENG-473`, `ENG-474`, `ENG-475`, `ENG-476` | See the Next-90-days recommendation above. The active remediation wave now retires the low-tier enum-field row, CDC failure metadata reflection, EventSourcing persisted type-name reflection, core Data command/query dispatch reflection, Behaviors.Http route/projection/module ownership reflection, Behaviors.Http result-envelope/generated-profile carrier/assembly-scan/profile-attribute/input-shape/route-contract fallback rows, Behaviors generated-carrier/assembly-scan/static-topology/execution-slot/type-registry rows, Behaviors.Patterns durable/saga fallback rows, and Engine module-discovery reflection while keeping global support `not-claimed`. |
...
| #3 — Deployment-mode claim validation needs a real harness | `partial` | `ENG-331`, `ENG-426`, `ENG-427`, `ENG-431`..`ENG-439`, `ENG-449`, `ENG-454`, `ENG-455`, `ENG-456`, `ENG-457`, `ENG-458`, `ENG-459`, `ENG-460`, `ENG-461`, `ENG-462`, `ENG-463`, `ENG-464`, `ENG-465`, `ENG-466`, `ENG-467`, `ENG-468`, `ENG-469`, `ENG-470`, `ENG-471`, `ENG-472`, `ENG-473`, `ENG-474`, `ENG-475`, `ENG-476` | The harness exists and runs in CI, the inventory feeding it is repo-owned, every package is classified, the default representative publish target set now covers five sample hosts, `Cephalon.Diagnostics` is the first package-scoped single-file claim, the manifest-backed inventory now emits as `HazardInventory` plus `hazard-inventory.json`, and the active remediation wave has removed REST wire-name enum reflection, generated behavior/durable execution open-generic startup reflection, CDC failure metadata reflection, EventSourcing persisted type-name reflection, Data command/query dispatch reflection, Behaviors.Http REST metadata/carrier/assembly-scan/profile-attribute/input-shape/route-contract fallback rows, Behaviors generated-carrier/assembly-scan/static-topology/execution-slot/type-registry rows, Behaviors.Patterns durable/saga fallback rows, and Engine module-discovery reflection. The remaining gating work is the MySQL third-party transport blocker, by-design ReferenceDocs posture, transitive validation, and intentionally removing `-SkipPublish` from release validation when full publish probing is ready to become a gate. |
