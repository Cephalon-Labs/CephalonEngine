...
10. Use `ICellBoundaryContributor` when the package owns an explicit cell boundary that operators should be able to inspect through `/engine/cells`, `/engine/technology-surfaces/cell-based-architecture`, and `/engine/snapshot`.
