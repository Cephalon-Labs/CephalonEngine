...
- `Cephalon.MultiTenancy.Governance`
  ...
  - projects `tenant-domain-ownership` for the Cephalon-managed declared domain-ownership catalog, store, validation, in-process verification-workflow, and reported-proof evaluation proof
...
- `Cephalon.MultiTenancy.Governance`
  ...
  - `MultiTenancyGovernanceOptions` for host-defined memberships, invitations, domain ownerships, governance actions, store paths, proof evaluation, and validation/evaluation/decision/workflow enablement
- `Cephalon.Eventing`
