...
- `Cephalon.MultiTenancy.Governance`
  ...
  - projects `tenant-domain-ownership` for the Cephalon-managed declared domain-ownership catalog, store, validation, in-process verification-workflow, proof-challenge issuance, proof-publication planning, reported-proof evaluation, HTTP file proof-collection proof, and configured DNS TXT proof-collection proof
...
- `Cephalon.MultiTenancy.Governance`
    ...
    - `MultiTenancyGovernanceOptions` for host-defined memberships, invitations, domain ownerships, governance actions, store paths, proof challenge defaults, proof publication planning, HTTP proof collection, DNS TXT proof collection resolver/timeout/size limits, proof verification runner orchestration, proof evaluation, and validation/evaluation/decision/workflow enablement
- `Cephalon.Eventing`
