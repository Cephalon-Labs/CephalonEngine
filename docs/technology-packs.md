...
- `Cephalon.Eventing`
  ...
  - reports `durable-remediation-command-audit` and `durable-command-journal-replay-cursor` separately so durable command audit, provider-owned command-journal replay, and broker replay ownership cannot be conflated
