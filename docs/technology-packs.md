...
- `Cephalon.MultiTenancy.Governance`
  ...
  - projects `tenant-domain-ownership` for the Cephalon-managed declared domain-ownership catalog, store, validation, and in-process verification-workflow proof
...
- `Cephalon.MultiTenancy.Governance`
  ...
  - `MultiTenancyGovernanceOptions` for host-defined memberships, invitations, domain ownerships, governance actions, store paths, and validation/evaluation/decision/workflow enablement
- `Cephalon.Eventing`
