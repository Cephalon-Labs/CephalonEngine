...
- `Cephalon.MultiTenancy.Governance.MailgunDelivery`
  ...
  - emits `Cephalon.MultiTenancy.Governance.MailgunDelivery` diagnostics while leaving Mailgun webhook callback translation/signature verification, SES, Microsoft Graph, SMS, chat, CRM, identity-provider onboarding, bounce handling, provider polling, callback inboxes, and provider-specific reconciliation semantics to future provider packs or applications
