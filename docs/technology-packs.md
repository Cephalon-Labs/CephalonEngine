...
- `Cephalon.MultiTenancy.Governance.AspNetCore`
  ...
  - keeps endpoint enablement, route pattern, cache-control, authorization, provider-message-match enforcement, callback signature headers/key id/tolerance, and endpoint-description posture configurable through `Engine:MultiTenancy:Governance:AspNetCore`
