...
- `Cephalon.MultiTenancy.Governance`
  ...
  - projects `tenant-domain-ownership` for the Cephalon-managed declared domain-ownership catalog, store, and validation proof
