...
- `Cephalon.MultiTenancy.Governance`
  ...
  - `MultiTenancyGovernanceOptions` for host-defined memberships, invitations, governance actions, and validation/evaluation/decision/workflow enablement
- `Cephalon.Eventing`
