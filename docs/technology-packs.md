...
- `Cephalon.MultiTenancy.Governance`
    ...
    - `MultiTenancyGovernanceOptions` for host-defined memberships, invitations, domain ownerships, governance actions, store paths, proof challenge defaults, proof publication planning, HTTP proof collection, proof evaluation, and validation/evaluation/decision/workflow enablement
- `Cephalon.Eventing`
