...
### #5 — Provider-native CDC integration scenarios for `Cephalon.Data.SqlServer`, `Cephalon.Data.Postgres`, and `Cephalon.Data.MongoDB` (medium priority, **shipped through `ENG-487` / [PR #1091](https://github.com/Cephalon-Labs/CephalonEngine/pull/1091), `ENG-490` / issue #1096, `ENG-491` / issue #1098, and `ENG-492` / issue #1100**)
