...
- [Cephalon.Abstractions](cephalon-abstractions.md): Host-agnostic contracts that module and package authors build against. Contains 21 namespaces and 565 public types. [Browse](browse.html?assembly=Cephalon.Abstractions)
- [Cephalon.Engine](cephalon-engine.md): Composition, runtime, policy, manifest, and introspection services. Contains 12 namespaces and 103 public types. [Browse](browse.html?assembly=Cephalon.Engine)
...
- [Cephalon.Eventing](cephalon-eventing.md): Event-driven integration runtime services and extension points. Contains 4 namespaces and 80 public types. [Browse](browse.html?assembly=Cephalon.Eventing)
...
- [Cephalon.AspNetCore](cephalon-aspnetcore.md): ASP.NET Core host core, REST surface, docs, health, and runtime endpoints. Contains 13 namespaces and 39 public types. [Browse](browse.html?assembly=Cephalon.AspNetCore)
...
- [Cephalon.Observability](cephalon-observability.md): Operational diagnostics and telemetry conventions for hosts. Contains 3 namespaces and 4 public types. [Browse](browse.html?assembly=Cephalon.Observability)
- [Cephalon.Observability.AlibabaCloud](cephalon-observability-alibabacloud.md): Alibaba Cloud OTLP defaults and managed OpenTelemetry traces/metrics integration for Cephalon hosts. Contains 2 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.Observability.AlibabaCloud)
- [Cephalon.Observability.Aws](cephalon-observability-aws.md): AWS OTLP defaults, X-Ray propagation, and hosted resource integration for Cephalon hosts. Contains 2 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.Observability.Aws)
- [Cephalon.Observability.AzureMonitor](cephalon-observability-azuremonitor.md): Azure Monitor exporter integration for Cephalon hosts. Contains 2 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.Observability.AzureMonitor)
...
- [Cephalon.Observability.DependencyHealth.Core](cephalon-observability-dependencyhealth-core.md): Shared dependency-health probe primitives for Cephalon observability companion packages. Contains 1 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.Observability.DependencyHealth.Core)
- [Cephalon.Observability.DigitalOcean](cephalon-observability-digitalocean.md): DigitalOcean collector defaults, hosted resource integration, and Droplet metadata guidance for Cephalon hosts. Contains 2 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.Observability.DigitalOcean)
...
- [Cephalon.Observability.Gcp](cephalon-observability-gcp.md): GCP OTLP defaults and Google-managed traces/metrics integration for Cephalon hosts. Contains 2 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.Observability.Gcp)
- [Cephalon.Observability.GrafanaCloud](cephalon-observability-grafanacloud.md): Grafana Cloud OTLP endpoint defaults and access-policy authentication guidance for Cephalon hosts. Contains 2 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.Observability.GrafanaCloud)
...
- [Cephalon.Observability.HuaweiCloud](cephalon-observability-huaweicloud.md): Huawei Cloud OTLP defaults and managed APM trace integration for Cephalon hosts. Contains 2 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.Observability.HuaweiCloud)
...
- [Cephalon.Observability.Kubernetes](cephalon-observability-kubernetes.md): Platform-neutral Kubernetes collector defaults and hosted resource integration for Cephalon hosts. Contains 2 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.Observability.Kubernetes)
...
- [Cephalon.Observability.NewRelic](cephalon-observability-newrelic.md): New Relic native OTLP endpoint defaults and api-key authentication guidance for Cephalon hosts. Contains 2 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.Observability.NewRelic)
...
- [Cephalon.Observability.OpenShift](cephalon-observability-openshift.md): Red Hat OpenShift collector defaults and hosted OTLP integration for Cephalon hosts. Contains 2 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.Observability.OpenShift)
...
- [Cephalon.Observability.OracleCloud](cephalon-observability-oraclecloud.md): Oracle Cloud APM OTLP defaults and managed traces/metrics integration for Cephalon hosts. Contains 2 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.Observability.OracleCloud)
...
- [Cephalon.MultiTenancy.Governance.SendGridDelivery](cephalon-multitenancy-governance-sendgriddelivery.md): SendGrid Mail Send API invitation delivery sender companion package for Cephalon multi-tenancy governance workloads. Contains 3 namespaces and 5 public types. [Browse](browse.html?assembly=Cephalon.MultiTenancy.Governance.SendGridDelivery)
...
- [Cephalon.MultiTenancy.Governance.AmazonSesDelivery](cephalon-multitenancy-governance-amazonsesdelivery.md): Amazon SES v2 invitation delivery sender companion package for Cephalon multi-tenancy governance workloads. Contains 3 namespaces and 5 public types. [Browse](browse.html?assembly=Cephalon.MultiTenancy.Governance.AmazonSesDelivery)
- [Cephalon.MultiTenancy.Governance.AmazonSesDelivery.AspNetCore](cephalon-multitenancy-governance-amazonsesdelivery-aspnetcore.md): ASP.NET Core Amazon SES over SNS callback translation companion package for Cephalon multi-tenancy governance workloads. Contains 3 namespaces and 8 public types. [Browse](browse.html?assembly=Cephalon.MultiTenancy.Governance.AmazonSesDelivery.AspNetCore)
- [Cephalon.MultiTenancy.Governance.MailgunDelivery.AspNetCore](cephalon-multitenancy-governance-mailgundelivery-aspnetcore.md): ASP.NET Core Mailgun webhook callback translation companion package for Cephalon multi-tenancy governance workloads. Contains 2 namespaces and 5 public types. [Browse](browse.html?assembly=Cephalon.MultiTenancy.Governance.MailgunDelivery.AspNetCore)
- [Cephalon.MultiTenancy.Governance.MicrosoftGraphDelivery](cephalon-multitenancy-governance-microsoftgraphdelivery.md): Microsoft Graph sendMail invitation delivery sender companion package for Cephalon multi-tenancy governance workloads. Contains 3 namespaces and 6 public types. [Browse](browse.html?assembly=Cephalon.MultiTenancy.Governance.MicrosoftGraphDelivery)
- [Cephalon.MultiTenancy.Governance.MicrosoftGraphDelivery.AzureIdentity](cephalon-multitenancy-governance-microsoftgraphdelivery-azureidentity.md): Azure.Identity token-provider companion package for Microsoft Graph tenant-invitation delivery. Contains 2 namespaces and 2 public types. [Browse](browse.html?assembly=Cephalon.MultiTenancy.Governance.MicrosoftGraphDelivery.AzureIdentity)
- [Cephalon.MultiTenancy.Governance.SendGridDelivery.AspNetCore](cephalon-multitenancy-governance-sendgriddelivery-aspnetcore.md): ASP.NET Core SendGrid Event Webhook callback translation companion package for Cephalon multi-tenancy governance workloads. Contains 2 namespaces and 5 public types. [Browse](browse.html?assembly=Cephalon.MultiTenancy.Governance.SendGridDelivery.AspNetCore)
...
- [Cephalon.EventSourcing.EntityFramework](cephalon-eventsourcing-entityframework.md): Entity Framework Core append/read event-store provider for Cephalon event-sourcing workloads. Contains 3 namespaces and 6 public types. [Browse](browse.html?assembly=Cephalon.EventSourcing.EntityFramework)
