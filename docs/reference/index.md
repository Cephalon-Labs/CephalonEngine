...
- [Cephalon.Abstractions](cephalon-abstractions.md): Host-agnostic contracts that module and package authors build against. Contains 22 namespaces and 573 public types. [Browse](browse.html?assembly=Cephalon.Abstractions)
- [Cephalon.Engine](cephalon-engine.md): Composition, runtime, policy, manifest, and introspection services. Contains 13 namespaces and 106 public types. [Browse](browse.html?assembly=Cephalon.Engine)
