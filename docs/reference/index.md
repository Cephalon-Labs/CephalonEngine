...
- [Cephalon.MultiTenancy.Governance](cephalon-multitenancy-governance.md): Tenant-membership, invitation, domain-ownership, and governance-action companion pack for Cephalon multi-tenancy workloads. Contains 3 namespaces and 128 public types. [Browse](browse.html?assembly=Cephalon.MultiTenancy.Governance)
