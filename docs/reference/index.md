...
- [Cephalon.Abstractions](cephalon-abstractions.md): Host-agnostic contracts that module and package authors build against. Contains 19 namespaces and 485 public types. [Browse](browse.html?assembly=Cephalon.Abstractions)
