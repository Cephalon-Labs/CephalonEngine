...
- [Cephalon.MultiTenancy.Governance](cephalon-multitenancy-governance.md): Tenant-membership, invitation, domain-ownership, and governance-action companion pack for Cephalon multi-tenancy workloads. Contains 3 namespaces and 121 public types. [Browse](browse.html?assembly=Cephalon.MultiTenancy.Governance)
- [Cephalon.MultiTenancy.Governance.AspNetCore](cephalon-multitenancy-governance-aspnetcore.md): ASP.NET Core HTTP proof publication and tenant-administration command adapter for Cephalon multi-tenancy governance workloads. Contains 2 namespaces and 7 public types. [Browse](browse.html?assembly=Cephalon.MultiTenancy.Governance.AspNetCore)
