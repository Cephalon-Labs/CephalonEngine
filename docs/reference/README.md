...
- [Cephalon.Abstractions](cephalon-abstractions.md): Host-agnostic contracts that module and package authors build against. Contains 18 namespaces and 269 public types. [Browse](browse.html?assembly=Cephalon.Abstractions)
- [Cephalon.Engine](cephalon-engine.md): Composition, runtime, policy, manifest, and introspection services. Contains 12 namespaces and 88 public types. [Browse](browse.html?assembly=Cephalon.Engine)
