...
- [Cephalon.MultiTenancy.Governance](cephalon-multitenancy-governance.md): Tenant-membership catalog and evaluation companion pack for Cephalon multi-tenancy workloads. Contains 3 namespaces and 54 public types. [Browse](browse.html?assembly=Cephalon.MultiTenancy.Governance)
