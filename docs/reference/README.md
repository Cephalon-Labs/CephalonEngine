...
- [Cephalon.Abstractions](cephalon-abstractions.md): Host-agnostic contracts that module and package authors build against. Contains 21 namespaces and 563 public types. [Browse](browse.html?assembly=Cephalon.Abstractions)
