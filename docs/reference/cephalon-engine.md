...
<a id="member-p-cephalon-engine-runtime-runtimeintrospectionsnapshot-agenttoolruns"></a>
...
<a id="member-p-cephalon-engine-runtime-runtimeintrospectionsnapshot-dataproducts"></a>
...
```csharp
IReadOnlyList<EventSubscriptionExecutionReadinessDescriptor> EventSubscriptionExecutionReadiness { get; set; }
```
