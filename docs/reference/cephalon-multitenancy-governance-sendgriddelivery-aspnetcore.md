...
<a id="member-p-cephalon-multitenancy-governance-sendgriddelivery-aspnetcore-configuration-sendgridinvitationdeliveryaspnetcoreoptions-enableeventwebhookeventididempotency"></a>

##### `EnableEventWebhookEventIdIdempotency`

```csharp
bool EnableEventWebhookEventIdIdempotency { get; set; }
```
...
Remarks: The endpoint uses the stable `sg_event_id`-backed observation id generated by the SendGrid mapper. This is observation-store-backed idempotency, not a durable raw callback inbox or distributed replay ledger.
...
- `duplicateEvents`: The number of translated SendGrid events skipped because their event id was already observed.
...
<a id="member-p-cephalon-multitenancy-governance-sendgriddelivery-aspnetcore-hosting-sendgridinvitationdeliverystatuscallbackresult-duplicateevents"></a>
