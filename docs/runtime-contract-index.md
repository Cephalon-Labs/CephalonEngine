...
| `GET /event-dispatch-remediation-commands*` | `Cephalon.AspNetCore` | bounded event-dispatch remediation command results with command-id, outbox, operation, outcome, and duplicate-command recovery drill-downs | optional |
