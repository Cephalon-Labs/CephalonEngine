...
It does not yet claim tenant membership workflows, invite flows, domain ownership validation, or product-specific backoffice/public-site orchestration. Those remain later slices.
