...
- `tenancy.domain-ownership.catalog`, `tenancy.domain-ownership.store`, `tenancy.domain-ownership.validation`, `tenancy.domain-ownership.workflow`, `tenancy.domain-ownership.proof-challenge`, `tenancy.domain-ownership.proof-publication-plan`, `tenancy.domain-ownership.proof-evaluation`, `tenancy.domain-ownership.http-proof-collection`, `tenancy.domain-ownership.dns-txt-proof-collection`, and `tenancy.domain-ownership.proof-verification-runner` capabilities when the `MultiTenancy` technology is active
