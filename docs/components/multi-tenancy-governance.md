...
- one provider-extension boundary for real invitation senders, with `Cephalon.MultiTenancy.Governance.HttpDelivery` supplying the optional first-party HTTP webhook sender, `Cephalon.MultiTenancy.Governance.SmtpDelivery` supplying the optional first-party SMTP relay sender, and `Cephalon.MultiTenancy.Governance.SendGridDelivery` supplying the optional first-party SendGrid Mail Send API sender
