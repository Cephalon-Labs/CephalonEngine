...
- stable governance diagnostics for allowed and denied membership evaluation, invitation validation, domain-ownership validation, domain-ownership verification workflow transitions, domain-ownership proof challenge issuance, domain-ownership proof publication planning, domain-ownership HTTP proof publication, domain-ownership proof evaluation, domain-ownership HTTP proof collection, domain-ownership DNS TXT proof collection, domain-ownership proof verification runs, on-demand and automatic background domain-ownership proof polling passes, domain-ownership store persistence, governance-action decisions, governance-action workflow transitions, and governance-action store persistence
