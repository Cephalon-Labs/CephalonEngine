...
- `tenancy.invitation.catalog`, `tenancy.invitation.store`, `tenancy.invitation.validation`, and `tenancy.invitation.delivery-dispatch` capabilities when the `MultiTenancy` technology is active and the related runtime path is enabled
