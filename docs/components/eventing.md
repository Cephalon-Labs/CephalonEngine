...
- `MassTransit` is the tracked-later companion adapter candidate once the engine-owned runtime-neutral contract and the optional Wolverine proof are strong enough to justify a second shipped adapter package
