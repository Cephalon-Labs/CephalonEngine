...
- terminal dispatch-failure metadata that dispatch stores can use to stop poison staged publications from re-entering pending-dispatch reads when a runtime exhausts its retry budget
