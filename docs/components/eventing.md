...
- baseline runtime-surface contributions for channel introspection, declared subscription introspection, truthful publication-path introspection, and dispatch-state introspection
...
- `Services/EventDispatchRuntimeState.cs`
...
- `Services/IEventDispatchRuntimeCatalog.cs`
