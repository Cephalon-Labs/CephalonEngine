...
- contributes the resolved physical-target truth that lets the engine-owned migration playbook and topology posture surface warn when multiple EF-backed logical migration targets share one physical database and still need coordinated deploy-time execution
