...
- contributes first-class resolved database-role runtime state through `IDatabaseRoleCatalog`, `/engine/database-roles`, and `snapshot.DatabaseRoles`, including live connectivity plus pending-migration diagnostics for registered `DbContext` roles
