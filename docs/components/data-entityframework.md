...
- exposes an opt-in Entity Framework-backed event-dispatch remediation command journal for durable operator command results and command-id duplicate detection
