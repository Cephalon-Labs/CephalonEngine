...
- additive CDC capture contracts and runtime CDC catalogs
...
host-only data mesh or sync registry. Provider-specific federation, self-serve data infrastructure,
and CDC execution remain later follow-through over those same catalogs.
