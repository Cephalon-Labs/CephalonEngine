...
- configuration binding for engine, trust, localization, failure policy, options, and the phase-8 `Data`, `Databases`, `Identity`, `Tenancy`, `Audit`, and `Messaging` sections
