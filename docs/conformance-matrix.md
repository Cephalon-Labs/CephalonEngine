...
No open inconsistencies remain at this snapshot. The list below records the alignment items resolved between ENG-388 and ENG-392 so the durable history stays visible.
