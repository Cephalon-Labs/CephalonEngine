...
6. **gate phase** computes `PublishProbeGate` so non-opt-out gated modes fail the run when their publish probe is skipped, targetless, failing, or warning-producing
