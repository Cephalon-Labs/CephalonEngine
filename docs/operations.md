...
- `Cephalon.MultiTenancy.Governance`: `4510-4547`
...
- `tenant-administration` reports the governance companion's Cephalon-managed host-driven administration workflow posture, including workflow enablement, membership and invitation administration ownership, membership/invitation store kinds, durability, counts, supported commands, and application-managed boundaries for public onboarding, tenant-admin endpoints, invitation delivery, and identity-provider sync
