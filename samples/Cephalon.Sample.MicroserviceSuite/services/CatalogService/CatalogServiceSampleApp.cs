...
/// <summary>
/// Builds the catalog-service sample host used by tests, docs, and local exploration.
/// </summary>
public static class CatalogServiceSampleApp
{
    /// <summary>
    /// Builds the catalog-service sample application with the default Cephalon host wiring.
    /// </summary>
    /// <param name="args">
    ...
    /// </param>
    /// <returns>
    /// The configured catalog-service sample application.
    /// </returns>
        ...
        Action<WebApplicationBuilder>? configureBuilder = null)
    {
        ...
        {
            Args = args ?? [],
            ApplicationName = typeof(CatalogServiceSampleApp).Assembly.FullName,
        ...
        app.MapGet("/", () => TypedResults.Ok(new
        {
            ...
            service = CommerceSuiteConventions.CatalogService,
