...
function Write-EngineCompletionScorecardEvidenceSummary {
    ...
    $deploymentModeClaimsReportOverstatedClaimCount = [System.Convert]::ToInt32(
        (Get-ScorecardRequiredPropertyValue `
            ...
            -OwnerName "DeploymentModeEvidence"),
        [System.Globalization.CultureInfo]::InvariantCulture)
    $deploymentModeClaimsReportBoundaryAnnotationAuditStatus = Get-ScorecardRequiredPropertyValue `
        -Object $scorecard.DeploymentModeEvidence `
        -PropertyName "ClaimsReportHazardInventoryBoundaryAnnotationAuditStatus" `
        -OwnerName "DeploymentModeEvidence"
    $deploymentModeClaimsReportBoundaryAnnotationAuditFailureCount = [System.Convert]::ToInt32(
        (Get-ScorecardRequiredPropertyValue `
            -Object $scorecard.DeploymentModeEvidence `
            -PropertyName "ClaimsReportHazardInventoryBoundaryAnnotationAuditFailureCount" `
            -OwnerName "DeploymentModeEvidence"),
        [System.Globalization.CultureInfo]::InvariantCulture)
    $deploymentModeClaimsReportCoreRouteDelegateAuditStatus = Get-ScorecardRequiredPropertyValue `
        -Object $scorecard.DeploymentModeEvidence `
        -PropertyName "ClaimsReportHazardInventoryCoreRouteDelegateAuditStatus" `
        -OwnerName "DeploymentModeEvidence"
    $deploymentModeClaimsReportCoreRouteDelegateAuditFailureCount = [System.Convert]::ToInt32(
        (Get-ScorecardRequiredPropertyValue `
            -Object $scorecard.DeploymentModeEvidence `
            -PropertyName "ClaimsReportHazardInventoryCoreRouteDelegateAuditFailureCount" `
            -OwnerName "DeploymentModeEvidence"),
        [System.Globalization.CultureInfo]::InvariantCulture)
    $deploymentModeClaimsReportFullCommonRouteDelegateAuditStatus = Get-ScorecardRequiredPropertyValue `
        -Object $scorecard.DeploymentModeEvidence `
        -PropertyName "ClaimsReportHazardInventoryFullCommonRouteDelegateAuditStatus" `
        -OwnerName "DeploymentModeEvidence"
    $deploymentModeClaimsReportFullCommonRouteDelegateAuditFailureCount = [System.Convert]::ToInt32(
        (Get-ScorecardRequiredPropertyValue `
            -Object $scorecard.DeploymentModeEvidence `
            -PropertyName "ClaimsReportHazardInventoryFullCommonRouteDelegateAuditFailureCount" `
            -OwnerName "DeploymentModeEvidence"),
        [System.Globalization.CultureInfo]::InvariantCulture)
    $deploymentModeClaimsReportFullOperatorRouteDelegateAuditStatus = Get-ScorecardRequiredPropertyValue `
        -Object $scorecard.DeploymentModeEvidence `
        -PropertyName "ClaimsReportHazardInventoryFullOperatorRouteDelegateAuditStatus" `
        -OwnerName "DeploymentModeEvidence"
    $deploymentModeClaimsReportFullOperatorRouteDelegateAuditFailureCount = [System.Convert]::ToInt32(
        (Get-ScorecardRequiredPropertyValue `
            -Object $scorecard.DeploymentModeEvidence `
            -PropertyName "ClaimsReportHazardInventoryFullOperatorRouteDelegateAuditFailureCount" `
            -OwnerName "DeploymentModeEvidence"),
        [System.Globalization.CultureInfo]::InvariantCulture)
    $deploymentModeClaimsReportOperatorResponseJsonContractAuditStatus = Get-ScorecardRequiredPropertyValue `
        -Object $scorecard.DeploymentModeEvidence `
        -PropertyName "ClaimsReportHazardInventoryOperatorResponseJsonContractAuditStatus" `
        -OwnerName "DeploymentModeEvidence"
    $deploymentModeClaimsReportOperatorResponseJsonContractAuditFailureCount = [System.Convert]::ToInt32(
        (Get-ScorecardRequiredPropertyValue `
            -Object $scorecard.DeploymentModeEvidence `
    ...
    $deploymentModeClaimsReportNonOperatorEndpointAuditFailureCount = [System.Convert]::ToInt32(
        (Get-ScorecardRequiredPropertyValue `
            ...
            -OwnerName "DeploymentModeEvidence"),
        [System.Globalization.CultureInfo]::InvariantCulture)
    $deploymentModeClaimsReportFrameworkEndpointBoundaryAuditStatus = Get-ScorecardRequiredPropertyValue `
        -Object $scorecard.DeploymentModeEvidence `
        -PropertyName "ClaimsReportHazardInventoryFrameworkEndpointBoundaryAuditStatus" `
        -OwnerName "DeploymentModeEvidence"
    $deploymentModeClaimsReportFrameworkEndpointBoundaryAuditFailureCount = [System.Convert]::ToInt32(
        (Get-ScorecardRequiredPropertyValue `
            -Object $scorecard.DeploymentModeEvidence `
            -PropertyName "ClaimsReportHazardInventoryFrameworkEndpointBoundaryAuditFailureCount" `
            -OwnerName "DeploymentModeEvidence"),
        [System.Globalization.CultureInfo]::InvariantCulture)
    ...
    if (-not $deploymentModeClaimsReportPresent -or
        ...
        $deploymentModeClaimsReportOverstatedClaimCount -ne 0 -or
        $deploymentModeClaimsReportBoundaryAnnotationAuditStatus -ne "matched" -or
        $deploymentModeClaimsReportBoundaryAnnotationAuditFailureCount -ne 0 -or
        $deploymentModeClaimsReportCoreRouteDelegateAuditStatus -ne "matched" -or
        $deploymentModeClaimsReportCoreRouteDelegateAuditFailureCount -ne 0 -or
        $deploymentModeClaimsReportFullCommonRouteDelegateAuditStatus -ne "matched" -or
        $deploymentModeClaimsReportFullCommonRouteDelegateAuditFailureCount -ne 0 -or
    ...
    Write-Host ("Deployment-mode evidence: {0} global claims; not-claimed {1}; package-scoped claim packages {2}; known hazards {3}; transitive audit entries {4}; publish probes {5}; claims report {6}; gate {7}; targets {8}; warnings {9}; errors {10}; truthful package claims {11}; overstated package claims {12}; boundary audit {13}/{14}; core route-delegate audit {15}/{16}; full common route-delegate audit {17}/{18}; full operator route-delegate audit {19}/{20}; operator response JSON contract audit {21}/{22}; non-operator endpoint audit {23}/{24}; framework endpoint boundary audit {25}/{26}." -f `
        ...
        $deploymentModeClaimsReportBoundaryAnnotationAuditStatus,
        $deploymentModeClaimsReportBoundaryAnnotationAuditFailureCount,
        $deploymentModeClaimsReportCoreRouteDelegateAuditStatus,
        $deploymentModeClaimsReportCoreRouteDelegateAuditFailureCount,
        $deploymentModeClaimsReportFullCommonRouteDelegateAuditStatus,
        $deploymentModeClaimsReportFullCommonRouteDelegateAuditFailureCount,
        ...
        $deploymentModeClaimsReportFrameworkEndpointBoundaryAuditStatus,
        $deploymentModeClaimsReportFrameworkEndpointBoundaryAuditFailureCount)
    ...
    $supplyChainSignedReleaseDryRunOutputPath = Get-ScorecardRequiredPropertyValue `
        ...
        -OwnerName "SupplyChainEvidence.SignedReleaseDryRun"
    $supplyChainSignedReleaseDryRunHandoffOutputPath = Get-ScorecardRequiredPropertyValue `
        -Object $supplyChainSignedReleaseDryRun `
        -PropertyName "HandoffOutputPath" `
        -OwnerName "SupplyChainEvidence.SignedReleaseDryRun"
    ...
    Write-Host ("Signed-release dry-run evidence: status {0}; proof {1}; blocker {2}; required command {3}; output {4}; handoff {5}." -f `
        ...
        $supplyChainSignedReleaseDryRunHandoffOutputPath)
