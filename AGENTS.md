...
- `Cephalon.MultiTenancy.Governance.AmazonSesDelivery.AspNetCore` is the optional ASP.NET Core Amazon SES over SNS callback translation, SNS signature-verification, and process-local SNS replay-protection companion package for the multi-tenancy governance delivery-status reconciler
