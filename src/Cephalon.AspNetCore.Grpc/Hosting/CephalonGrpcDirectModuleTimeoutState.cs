...
internal sealed class CephalonGrpcDirectModuleTimeoutState
{
    private readonly CephalonGrpcDirectModuleResilienceOptions options;
    private long timeoutCount;
    private long lastTimeoutAtUtcTicks;

    public CephalonGrpcDirectModuleTimeoutState(CephalonGrpcDirectModuleResilienceOptions options)
    {
