...
internal sealed class CephalonGrpcDirectModuleBulkheadState : IDisposable
{
    ...
    public CephalonGrpcDirectModuleBulkheadState(CephalonGrpcDirectModuleResilienceOptions options)
    {
    ...
    {
        private readonly CephalonGrpcDirectModuleBulkheadState? owner;

        internal Lease(CephalonGrpcDirectModuleBulkheadState owner)
        {
            this.owner = owner;
        }
