...
public sealed class RestApiGovernanceOptions
{
    ...
    public RestApiGovernanceOptions(IReadOnlyList<RestEndpointSuppressionOptions>? suppressions = null)
    {
    ...
    /// </summary>
    public bool HasValues => Suppressions.Count > 0;
        ...
        string sectionPath = SectionName)
    {
        ...
        return new RestApiGovernanceOptions(suppressions);
    }
