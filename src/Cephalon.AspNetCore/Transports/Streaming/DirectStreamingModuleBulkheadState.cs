...
internal sealed class DirectStreamingModuleBulkheadState : IDisposable
{
    ...
    public DirectStreamingModuleBulkheadState(DirectStreamingModuleResilienceOptions options)
    {
    ...
    {
        private readonly DirectStreamingModuleBulkheadState? owner;

        internal Lease(DirectStreamingModuleBulkheadState owner)
        {
            this.owner = owner;
        }
