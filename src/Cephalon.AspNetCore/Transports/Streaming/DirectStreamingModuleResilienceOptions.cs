...
internal sealed class DirectStreamingModuleResilienceOptions
{
    ...
    private DirectStreamingModuleResilienceOptions(
        bool timeoutEnabled,
        TimeSpan? timeout,
    ...
    public static DirectStreamingModuleResilienceOptions Empty { get; } = new(
    ...
    public static DirectStreamingModuleResilienceOptions FromManifest(RuntimeManifest? manifest)
    {
        if (manifest is null)
        {
            return Empty;
        ...
        return new DirectStreamingModuleResilienceOptions(
            timeout.Enabled,
            timeout.Timeout,
