        ...
        ApiRoutesOptions apiRoutesOptions)
    {
        ...
        if (behaviorMetadata is not null)
        {
            return RestEndpointRuntimeDescriptorFactory.CreateBehaviorDescriptor(
                ...
                originalEndpointName: behaviorMetadata.OriginalEndpointName,
                originalSummary: behaviorMetadata.OriginalSummary,
                originalDescription: behaviorMetadata.OriginalDescription,
                candidateId: behaviorMetadata.CandidateId,
                originalProjection: behaviorMetadata.OriginalProjection,
