...
internal sealed class GraphQLExecutionBulkheadState : IDisposable
{
    ...
    public GraphQLExecutionBulkheadState(GraphQLExecutionResilienceOptions options)
    {
    ...
    {
        private readonly GraphQLExecutionBulkheadState? owner;

        internal Lease(GraphQLExecutionBulkheadState owner)
        {
            this.owner = owner;
        }
