...
internal sealed class GraphQLExecutionCircuitBreakerState
{
    ...
    public GraphQLExecutionCircuitBreakerState(GraphQLExecutionResilienceOptions options)
    {
    ...
    public int RetryAfterSeconds
    {
        get
        {
            lock (gate)
            {
                return ResolveRetryAfterSeconds(DateTimeOffset.UtcNow);
            }
        }
    }
