...
/// <summary>
/// Contributes the ClickHouse inbox store surface to the active technology runtime catalog.
/// </summary>
internal sealed class ClickHouseInboxRuntimeSurfaceContributor(IInboxCatalog catalog) : ITechnologyRuntimeContributor
{
    /// <inheritdoc />
