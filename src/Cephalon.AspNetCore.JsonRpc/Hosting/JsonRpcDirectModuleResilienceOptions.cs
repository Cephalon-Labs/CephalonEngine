...
internal sealed class JsonRpcDirectModuleResilienceOptions
{
    ...
    private JsonRpcDirectModuleResilienceOptions(
        bool timeoutEnabled,
        TimeSpan? timeout,
    ...
    public static JsonRpcDirectModuleResilienceOptions Empty { get; } = new(
    ...
    public static JsonRpcDirectModuleResilienceOptions FromManifest(RuntimeManifest? manifest)
    {
        if (manifest is null)
        {
            return Empty;
        ...
        return new JsonRpcDirectModuleResilienceOptions(
            timeout.Enabled,
            timeout.Timeout,
