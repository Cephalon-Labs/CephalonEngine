...
/// <summary>
/// Contributes the Qdrant inbox store surface to the active technology runtime catalog.
/// </summary>
internal sealed class QdrantInboxRuntimeSurfaceContributor(IInboxCatalog catalog) : ITechnologyRuntimeContributor
{
    /// <inheritdoc />
