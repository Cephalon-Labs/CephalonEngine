...
/// <summary>
/// Contributes the Qdrant outbox producer surface to the active technology runtime catalog.
/// </summary>
internal sealed class QdrantOutboxRuntimeSurfaceContributor(IOutboxCatalog catalog) : ITechnologyRuntimeContributor
{
    /// <inheritdoc />
    public TechnologyRuntimeSurface DescribeRuntimeSurface()
    {
        return new TechnologyRuntimeSurface(
            ...
            entries: catalog.GetByProvider(QdrantDataOptions.ProviderId)
                .Select(CreateEntry)
                .ToArray());
    }
