    ...
    TenantInvitationDeliveryStatusEndpointRuntimeCatalog runtimeCatalog) : ITechnologyRuntimeContributor
{
    public TechnologyRuntimeSurface DescribeRuntimeSurface()
    {
        ...
        var metadata = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["observationSummaryDimensions"] = "status,attention,remediation,outcome,source,providerMessageId,channel,sender,tenant",
            ...
            ["observationProviderMessageFilterOwnership"] = observationEndpointOwnership,
            ["observationProviderMessageFilterScope"] = "matched-normalized-observation-provider-message",
            ["observationRemediationFilterOwnership"] = observationEndpointOwnership,
            ["observationRemediationFilterScope"] = "matched-normalized-observation-remediation",
