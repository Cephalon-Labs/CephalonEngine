    ...
    IServiceScopeFactory scopeFactory) : ITechnologyRuntimeContributor
{
        ...
        TestabilityBenchmarkProfile testabilityBenchmark)
    {
        ...
        var promotionGate = complete ? "allowed" : "blocked";
        var promotionAllowed = complete;
        var promotionDecisionCode = complete
            ? "all-required-dimensions-claimed"
