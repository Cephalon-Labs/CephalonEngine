...
/// <summary>
/// Contributes the MongoDB inbox store surface to the active technology runtime catalog.
/// </summary>
internal sealed class MongoDbInboxRuntimeSurfaceContributor(IInboxCatalog catalog) : ITechnologyRuntimeContributor
{
    /// <inheritdoc />
