...
public static class ReferenceDocsGenerator
{
    ...
    [
        ...
        new("Cephalon.MultiTenancy.Governance", "Phase 8 Companion Packs", "Tenant-membership catalog and evaluation companion pack for Cephalon multi-tenancy workloads."),
