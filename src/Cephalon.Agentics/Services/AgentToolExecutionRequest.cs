...
public sealed class AgentToolExecutionRequest
{
    ...
    /// </summary>
    /// <param name="toolId">The stable tool identifier to execute.</param>
    /// <param name="runId">The stable run identifier. A generated identifier is used when omitted.</param>
