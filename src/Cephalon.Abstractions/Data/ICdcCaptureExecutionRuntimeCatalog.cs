...
public interface ICdcCaptureExecutionRuntimeCatalog
{
    ...
    /// </summary>
    /// <param name="providerOwnedControlPlaneOwnershipState">The stable provider-owned control-plane ownership state identifier to filter by.</param>
    /// <returns>The matching execution-runtime descriptors, or an empty list when no runtime currently reports that provider-owned control-plane ownership state.</returns>
    ...
    /// </summary>
    /// <param name="providerOwnedControlPlaneOwnershipCategory">The stable provider-owned control-plane ownership category identifier to filter by.</param>
    /// <returns>The matching execution-runtime descriptors, or an empty list when no runtime currently reports that provider-owned control-plane ownership category.</returns>
    ...
    /// </summary>
    /// <param name="operationId">The stable provider-owned control-plane ownership operation identifier to filter by.</param>
    /// <returns>The matching execution-runtime descriptors, or an empty list when no runtime currently reports that operation identifier.</returns>
    ...
    /// </summary>
    /// <param name="providerOwnedControlPlaneMutationReconcileState">The stable provider-owned control-plane mutation and reconcile state identifier to filter by.</param>
    /// <returns>The matching execution-runtime descriptors, or an empty list when no runtime currently reports that provider-owned control-plane mutation and reconcile state.</returns>
    ...
    /// </summary>
    /// <param name="providerOwnedControlPlaneMutationReconcileCategory">The stable provider-owned control-plane mutation and reconcile category identifier to filter by.</param>
    /// <returns>The matching execution-runtime descriptors, or an empty list when no runtime currently reports that provider-owned control-plane mutation and reconcile category.</returns>
    ...
    /// </summary>
    /// <param name="operationId">The stable provider-owned control-plane mutation and reconcile operation identifier to filter by.</param>
    /// <returns>The matching execution-runtime descriptors, or an empty list when no runtime currently reports that operation identifier.</returns>
    ...
    /// </summary>
    /// <param name="transportKind">The stable transport kind to filter by.</param>
    /// <returns>The matching execution-runtime descriptors, or an empty list when no runtime currently reports that transport kind.</returns>
    ...
    /// </summary>
    /// <param name="transportKind">The stable transport kind to filter on.</param>
    /// <returns>The matching execution-runtime descriptors, or an empty list when no runtime currently reports that transport kind.</returns>
