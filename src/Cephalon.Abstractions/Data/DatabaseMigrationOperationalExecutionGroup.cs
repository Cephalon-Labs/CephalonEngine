...
public sealed class DatabaseMigrationOperationalExecutionGroup
{
        ...
        string? coordinationHint = null)
    {
        ...
        if (productionReadyTargetCount < 0)
        {
            throw new ArgumentOutOfRangeException(
        ...
        if (TargetCount > 0 && productionReadyTargetCount > TargetCount)
        {
            throw new ArgumentOutOfRangeException(
                nameof(productionReadyTargetCount),
                productionReadyTargetCount,
        ...
        if (TargetCount > 0 && manualPathTargetCount > TargetCount)
        {
            throw new ArgumentOutOfRangeException(
                nameof(manualPathTargetCount),
                manualPathTargetCount,
        ...
        ProductionReadyTargetCount = productionReadyTargetCount;
        ManualPathTargetCount = manualPathTargetCount;
