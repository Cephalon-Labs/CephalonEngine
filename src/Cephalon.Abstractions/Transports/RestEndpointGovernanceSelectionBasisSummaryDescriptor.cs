...
public sealed class RestEndpointGovernanceSelectionBasisSummaryDescriptor
{
    ...
    /// </param>
    public RestEndpointGovernanceSelectionBasisSummaryDescriptor(
...
internal static class RestEndpointGovernanceSelectionBasisSummaryBuilder
{
    internal static RestEndpointGovernanceSelectionBasisSummaryDescriptor[] BuildFromCandidates(
        ...
        Func<RestEndpointCandidateRuntimeDescriptor, RestEndpointGovernanceRuleSelectionBasis?> selector)
    {
        ...
        return candidateIdsBySelectionBasis
            ...
            .Select(pair =>
                new RestEndpointGovernanceSelectionBasisSummaryDescriptor(
                    pair.Key,
                    pair.Value))
            .ToArray();
    }

    internal static RestEndpointGovernanceSelectionBasisSummaryDescriptor[] Normalize(
        IReadOnlyList<RestEndpointGovernanceSelectionBasisSummaryDescriptor>? summaries,
        ...
        string parameterName)
    {
        ...
        var result = new List<RestEndpointGovernanceSelectionBasisSummaryDescriptor>(summaries.Count);
                     ...
                     .OrderBy(static summary => summary.SelectionBasis))
        {
            ...
            {
                throw new ArgumentException(
                    "Grouped selection-basis summary candidate ids must refer to candidates in the enclosing governance answer.",
                    parameterName);
            }
            ...
            result.Add(new RestEndpointGovernanceSelectionBasisSummaryDescriptor(
