...
public sealed class RestEndpointGovernanceSuppressionSummaryDescriptor
{
    ...
    /// </param>
    public RestEndpointGovernanceSuppressionSummaryDescriptor(
        string ruleId,
...
internal static class RestEndpointGovernanceSuppressionSummaryBuilder
{
    internal static RestEndpointGovernanceSuppressionSummaryDescriptor[] BuildFromCandidates(
    ...
    internal static RestEndpointGovernanceSuppressionSummaryDescriptor[] Normalize(
        IReadOnlyList<RestEndpointGovernanceSuppressionSummaryDescriptor>? summaries,
        ...
        string parameterName)
    {
        ...
        var result = new List<RestEndpointGovernanceSuppressionSummaryDescriptor>(summaries.Count);
                     ...
                     .OrderBy(static summary => summary.RuleId, StringComparer.OrdinalIgnoreCase))
        {
            ...
            {
                throw new ArgumentException(
                    "Grouped suppression-rule summary matched candidate ids must refer to candidates in the enclosing governance answer.",
                    parameterName);
            }
            ...
            {
                throw new ArgumentException(
                    "Grouped suppression-rule summary suppressed candidate ids must refer to candidates in the enclosing governance answer.",
                    parameterName);
            }
            ...
            result.Add(new RestEndpointGovernanceSuppressionSummaryDescriptor(
                summary.RuleId,
