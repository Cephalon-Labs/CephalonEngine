...
public sealed class RestEndpointGovernanceSkippedOverrideSummaryDescriptor
{
    ...
    /// </param>
    public RestEndpointGovernanceSkippedOverrideSummaryDescriptor(
        string ruleId,
...
internal static class RestEndpointGovernanceSkippedOverrideSummaryBuilder
{
    internal static RestEndpointGovernanceSkippedOverrideSummaryDescriptor[] BuildFromCandidates(
    ...
    internal static RestEndpointGovernanceSkippedOverrideSummaryDescriptor[] Normalize(
        IReadOnlyList<RestEndpointGovernanceSkippedOverrideSummaryDescriptor>? summaries,
        ...
        string parameterName)
    {
        ...
        var result = new List<RestEndpointGovernanceSkippedOverrideSummaryDescriptor>(summaries.Count);
        ...
        foreach (var summary in summaries.Where(static summary => summary is not null))
        {
            ...
            {
                throw new ArgumentException(
                    "Grouped skipped override-rule summary candidate ids must refer to candidates in the enclosing governance answer.",
                    parameterName);
            }

            result.Add(new RestEndpointGovernanceSkippedOverrideSummaryDescriptor(
                summary.RuleId,
