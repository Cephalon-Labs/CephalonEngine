...
public sealed class RestEndpointGovernanceSkippedSuppressionSummaryDescriptor
{
    ...
    /// </param>
    public RestEndpointGovernanceSkippedSuppressionSummaryDescriptor(
        string ruleId,
...
internal static class RestEndpointGovernanceSkippedSuppressionSummaryBuilder
{
    internal static RestEndpointGovernanceSkippedSuppressionSummaryDescriptor[] BuildFromCandidates(
    ...
    internal static RestEndpointGovernanceSkippedSuppressionSummaryDescriptor[] Normalize(
        IReadOnlyList<RestEndpointGovernanceSkippedSuppressionSummaryDescriptor>? summaries,
        ...
        string parameterName)
    {
        ...
        var result = new List<RestEndpointGovernanceSkippedSuppressionSummaryDescriptor>(summaries.Count);
        ...
        foreach (var summary in summaries.Where(static summary => summary is not null))
        {
            ...
            {
                throw new ArgumentException(
                    "Grouped skipped suppression-rule summary candidate ids must refer to candidates in the enclosing governance answer.",
                    parameterName);
            }

            result.Add(new RestEndpointGovernanceSkippedSuppressionSummaryDescriptor(
                summary.RuleId,
