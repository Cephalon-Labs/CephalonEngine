...
/// <summary>
/// Contributes the Redis outbox producer surface to the active technology runtime catalog.
/// </summary>
internal sealed class RedisOutboxRuntimeSurfaceContributor(IOutboxCatalog catalog) : ITechnologyRuntimeContributor
{
    /// <inheritdoc />
    public TechnologyRuntimeSurface DescribeRuntimeSurface()
    {
        return new TechnologyRuntimeSurface(
            ...
            entries: catalog.GetByProvider(RedisDataOptions.ProviderId)
                .Select(CreateEntry)
                .ToArray());
    }
