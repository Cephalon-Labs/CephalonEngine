...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OracleDependencyHealthOptions" /> class.
    /// </summary>
    ...
    /// </summary>
    public IReadOnlyList<OracleDependencyDefinition> Dependencies { get; set; } = Array.Empty<OracleDependencyDefinition>();
    ...
    public static OracleDependencyHealthOptions FromConfiguration(
    ...
    private static OracleDependencyHealthOptions FromSection(IConfigurationSection section)
    {
        ...
        return new OracleDependencyHealthOptions
        {
    ...
    private static OracleDependencyDefinition ParseDependency(IConfigurationSection section)
    {
        return new OracleDependencyDefinition
        {
            ...
            Port = GetInt32(section["Port"], defaultValue: 1521),
            ServiceName = section["ServiceName"]?.Trim() ?? string.Empty,
            Username = section["Username"]?.Trim(),
            Password = section["Password"],
            HealthQuery = section["HealthQuery"]?.Trim() ?? "SELECT 1 FROM DUAL",
