...
That gives adopters one truthful command for machine readiness, deployment-mode support posture, generated-app bootstrap readiness, generated host target-framework posture, generated self-hosted and hosted deployment assets plus container deployment-asset and Dockerfile-baseline posture, and generated publish-mode claim posture before they restore, run, publish, or deploy.
