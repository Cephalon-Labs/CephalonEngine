...
internal static class DoctorCommand
{
    ...
    private const string RequiredScorecardSchemaVersion = "1.25.0";
        ...
        ICollection<DoctorCheck> checks)
    {
        ...
        var deploymentModeClaimsReportPresent = GetRequiredScorecardBool(summary, "DeploymentModeClaimsReportPresent", errors);
        var deploymentModeClaimsReportPublishProbeTargetCount = GetRequiredScorecardInt(summary, "DeploymentModeClaimsReportPublishProbeTargetCount", errors);
        var deploymentModeClaimsReportPublishProbeWarningCount = GetRequiredScorecardInt(summary, "DeploymentModeClaimsReportPublishProbeWarningCount", errors);
        ...
        var deploymentModeClaimsReportFullOperatorRouteDelegateAuditFailures = GetRequiredScorecardInt(summary, "DeploymentModeClaimsReportFullOperatorRouteDelegateAuditFailures", errors);
        var deploymentModeClaimsReportOperatorResponseJsonContractAuditFailures = GetRequiredScorecardInt(summary, "DeploymentModeClaimsReportOperatorResponseJsonContractAuditFailures", errors);
        var deploymentModeClaimsReportNonOperatorEndpointAuditFailures = GetRequiredScorecardInt(summary, "DeploymentModeClaimsReportNonOperatorEndpointAuditFailures", errors);
        var deploymentModeClaimsReportFrameworkEndpointBoundaryAuditFailures = GetRequiredScorecardInt(summary, "DeploymentModeClaimsReportFrameworkEndpointBoundaryAuditFailures", errors);
        ...
        var adoptionSmokeGoldenUseCaseExecutionReportCount = GetRequiredScorecardInt(summary, "AdoptionSmokeGoldenUseCaseExecutionReportCount", errors);
        ...
        var srePendingBaselineRowCount = GetRequiredScorecardInt(summary, "SrePendingBaselineRowCount", errors);
        var srePendingBaselineBlockerCount = GetRequiredScorecardInt(summary, "SrePendingBaselineBlockerCount", errors);
        var srePendingBaselineEvidenceCount = GetRequiredScorecardInt(summary, "SrePendingBaselineEvidenceCount", errors);
        ...
        var evidenceDeploymentModeClaimsReport = GetRequiredScorecardString(deploymentModeEvidence, "ClaimsReport", errors, "DeploymentModeEvidence") ?? "unknown";
        var evidenceDeploymentModeClaimsReportPresent = GetRequiredScorecardBool(deploymentModeEvidence, "ClaimsReportPresent", errors, "DeploymentModeEvidence");
        var evidenceDeploymentModeClaimsReportGateStatus = GetRequiredScorecardString(deploymentModeEvidence, "ClaimsReportPublishProbeGateStatus", errors, "DeploymentModeEvidence") ?? "unknown";
        var evidenceDeploymentModeClaimsReportPublishProbeTargetCount = GetRequiredScorecardInt(deploymentModeEvidence, "ClaimsReportPublishProbeTargetCount", errors, "DeploymentModeEvidence");
        var evidenceDeploymentModeClaimsReportPublishProbeWarningCount = GetRequiredScorecardInt(deploymentModeEvidence, "ClaimsReportPublishProbeWarningCount", errors, "DeploymentModeEvidence");
        ...
        var evidenceDeploymentModeClaimsReportBoundaryAnnotationAuditStatus = GetRequiredScorecardString(deploymentModeEvidence, "ClaimsReportHazardInventoryBoundaryAnnotationAuditStatus", errors, "DeploymentModeEvidence") ?? "unknown";
        ...
        var evidenceDeploymentModeClaimsReportFullOperatorRouteDelegateAuditStatus = GetRequiredScorecardString(deploymentModeEvidence, "ClaimsReportHazardInventoryFullOperatorRouteDelegateAuditStatus", errors, "DeploymentModeEvidence") ?? "unknown";
        var evidenceDeploymentModeClaimsReportFullOperatorRouteDelegateAuditFailureCount = GetRequiredScorecardInt(deploymentModeEvidence, "ClaimsReportHazardInventoryFullOperatorRouteDelegateAuditFailureCount", errors, "DeploymentModeEvidence");
        var evidenceDeploymentModeClaimsReportOperatorResponseJsonContractAuditStatus = GetRequiredScorecardString(deploymentModeEvidence, "ClaimsReportHazardInventoryOperatorResponseJsonContractAuditStatus", errors, "DeploymentModeEvidence") ?? "unknown";
        var evidenceDeploymentModeClaimsReportOperatorResponseJsonContractAuditFailureCount = GetRequiredScorecardInt(deploymentModeEvidence, "ClaimsReportHazardInventoryOperatorResponseJsonContractAuditFailureCount", errors, "DeploymentModeEvidence");
        var evidenceDeploymentModeClaimsReportNonOperatorEndpointAuditStatus = GetRequiredScorecardString(deploymentModeEvidence, "ClaimsReportHazardInventoryNonOperatorEndpointAuditStatus", errors, "DeploymentModeEvidence") ?? "unknown";
        var evidenceDeploymentModeClaimsReportNonOperatorEndpointAuditFailureCount = GetRequiredScorecardInt(deploymentModeEvidence, "ClaimsReportHazardInventoryNonOperatorEndpointAuditFailureCount", errors, "DeploymentModeEvidence");
        var evidenceDeploymentModeClaimsReportFrameworkEndpointBoundaryAuditStatus = GetRequiredScorecardString(deploymentModeEvidence, "ClaimsReportHazardInventoryFrameworkEndpointBoundaryAuditStatus", errors, "DeploymentModeEvidence") ?? "unknown";
        var evidenceDeploymentModeClaimsReportFrameworkEndpointBoundaryAuditFailureCount = GetRequiredScorecardInt(deploymentModeEvidence, "ClaimsReportHazardInventoryFrameworkEndpointBoundaryAuditFailureCount", errors, "DeploymentModeEvidence");
        ...
        var evidenceAdoptionSmokeGoldenUseCaseExecutionReportCount = 0;
        if (adoptionSmokeEvidence?["GoldenUseCases"] is JsonArray adoptionSmokeGoldenUseCases)
        {
            foreach (var useCase in adoptionSmokeGoldenUseCases)
            {
                ...
                if (useCase?["ExecutionReport"] is JsonObject)
                {
                    evidenceAdoptionSmokeGoldenUseCaseExecutionReportCount++;
                }
            }
        }
        ...
        var evidenceSreStableBaselineManifest = GetRequiredScorecardString(srePostureEvidence, "StableBaselineManifest", errors, "SrePostureEvidence") ?? "unknown";
        var evidenceSreStableBaselineRowCount = GetRequiredScorecardInt(srePostureEvidence, "StableBaselineRowCount", errors, "SrePostureEvidence");
        var evidenceSreStableBaselineMeasurementCount = GetRequiredScorecardInt(srePostureEvidence, "StableBaselineMeasurementCount", errors, "SrePostureEvidence");
        var evidenceSrePendingBaselineRowCount = GetRequiredScorecardInt(srePostureEvidence, "PendingBaselineRowCount", errors, "SrePostureEvidence");
        var evidenceSrePendingBaselineBlockerCount = GetRequiredScorecardInt(srePostureEvidence, "PendingBaselineBlockerCount", errors, "SrePostureEvidence");
        var evidenceSrePendingBaselineEvidenceCount = GetRequiredScorecardInt(srePostureEvidence, "PendingBaselineEvidenceCount", errors, "SrePostureEvidence");
        ...
        var evidenceSupplyChainExternalPolicyPreflightCheckCount = GetRequiredScorecardInt(supplyChainEvidence, "ExternalPolicyPreflightCheckCount", errors, "SupplyChainEvidence");
        var supplyChainExternalPolicyPreflight = supplyChainEvidence?["ExternalPolicyPreflight"];
        if (supplyChainExternalPolicyPendingCount > 0 && supplyChainExternalPolicyPreflight is null)
        {
            errors.Add("SupplyChainEvidence.ExternalPolicyPreflight");
        }

        var evidenceSupplyChainExternalPolicyPreflightStatus = supplyChainExternalPolicyPreflight is null
            ? "not-required"
            : GetRequiredScorecardString(
                supplyChainExternalPolicyPreflight,
                "Status",
                errors,
        ...
        var evidenceSupplyChainSignedReleaseDryRunOutputPath = GetRequiredScorecardString(
            ...
            errors,
            "SupplyChainEvidence.SignedReleaseDryRun") ?? "unknown";
        var evidenceSupplyChainSignedReleaseDryRunHandoffOutputPath = GetRequiredScorecardString(
            supplyChainSignedReleaseDryRun,
            "HandoffOutputPath",
            errors,
            "SupplyChainEvidence.SignedReleaseDryRun") ?? "unknown";
        ...
        if (deploymentModeGlobalClaimCount != evidenceDeploymentModeGlobalClaimCount ||
            ...
            deploymentModeClaimsReportPresent != evidenceDeploymentModeClaimsReportPresent ||
            deploymentModeClaimsReportPublishProbeTargetCount != evidenceDeploymentModeClaimsReportPublishProbeTargetCount ||
            deploymentModeClaimsReportPublishProbeWarningCount != evidenceDeploymentModeClaimsReportPublishProbeWarningCount ||
            deploymentModeClaimsReportPublishProbeErrorCount != evidenceDeploymentModeClaimsReportPublishProbeErrorCount ||
            ...
            deploymentModeClaimsReportFullOperatorRouteDelegateAuditFailures != evidenceDeploymentModeClaimsReportFullOperatorRouteDelegateAuditFailureCount ||
            deploymentModeClaimsReportOperatorResponseJsonContractAuditFailures != evidenceDeploymentModeClaimsReportOperatorResponseJsonContractAuditFailureCount ||
            deploymentModeClaimsReportNonOperatorEndpointAuditFailures != evidenceDeploymentModeClaimsReportNonOperatorEndpointAuditFailureCount ||
            deploymentModeClaimsReportFrameworkEndpointBoundaryAuditFailures != evidenceDeploymentModeClaimsReportFrameworkEndpointBoundaryAuditFailureCount)
        {
            checks.Add(new DoctorCheck(
                DoctorCheckSeverity.Failure,
        ...
        if (!evidenceDeploymentModeClaimsReportPresent ||
            !string.Equals(evidenceDeploymentModeClaimsReportGateStatus, "passed", StringComparison.OrdinalIgnoreCase) ||
            evidenceDeploymentModeClaimsReportPublishProbeWarningCount != 0 ||
            evidenceDeploymentModeClaimsReportPublishProbeErrorCount != 0 ||
            evidenceDeploymentModeClaimsReportPackageClaimOverstatedCount != 0 ||
            ...
            !string.Equals(evidenceDeploymentModeClaimsReportFullOperatorRouteDelegateAuditStatus, "matched", StringComparison.OrdinalIgnoreCase) ||
            evidenceDeploymentModeClaimsReportFullOperatorRouteDelegateAuditFailureCount != 0 ||
            !string.Equals(evidenceDeploymentModeClaimsReportOperatorResponseJsonContractAuditStatus, "matched", StringComparison.OrdinalIgnoreCase) ||
            evidenceDeploymentModeClaimsReportOperatorResponseJsonContractAuditFailureCount != 0 ||
            !string.Equals(evidenceDeploymentModeClaimsReportNonOperatorEndpointAuditStatus, "matched", StringComparison.OrdinalIgnoreCase) ||
            evidenceDeploymentModeClaimsReportNonOperatorEndpointAuditFailureCount != 0 ||
            !string.Equals(evidenceDeploymentModeClaimsReportFrameworkEndpointBoundaryAuditStatus, "matched", StringComparison.OrdinalIgnoreCase) ||
            evidenceDeploymentModeClaimsReportFrameworkEndpointBoundaryAuditFailureCount != 0)
        {
            checks.Add(new DoctorCheck(
                DoctorCheckSeverity.Failure,
                "Engine completion scorecard deployment-mode evidence",
                $"Artifact '{resolvedScorecardPath}' has an invalid deployment-mode claims report readback: report {evidenceDeploymentModeClaimsReport}, present {evidenceDeploymentModeClaimsReportPresent}, gate {evidenceDeploymentModeClaimsReportGateStatus}, warnings {evidenceDeploymentModeClaimsReportPublishProbeWarningCount}, errors {evidenceDeploymentModeClaimsReportPublishProbeErrorCount}, overstated package claims {evidenceDeploymentModeClaimsReportPackageClaimOverstatedCount}, boundary audit {evidenceDeploymentModeClaimsReportBoundaryAnnotationAuditStatus}/{evidenceDeploymentModeClaimsReportBoundaryAnnotationAuditFailureCount}, core route-delegate audit {evidenceDeploymentModeClaimsReportCoreRouteDelegateAuditStatus}/{evidenceDeploymentModeClaimsReportCoreRouteDelegateAuditFailureCount}, full common route-delegate audit {evidenceDeploymentModeClaimsReportFullCommonRouteDelegateAuditStatus}/{evidenceDeploymentModeClaimsReportFullCommonRouteDelegateAuditFailureCount}, full operator route-delegate audit {evidenceDeploymentModeClaimsReportFullOperatorRouteDelegateAuditStatus}/{evidenceDeploymentModeClaimsReportFullOperatorRouteDelegateAuditFailureCount}, operator response JSON contract audit {evidenceDeploymentModeClaimsReportOperatorResponseJsonContractAuditStatus}/{evidenceDeploymentModeClaimsReportOperatorResponseJsonContractAuditFailureCount}, non-operator endpoint audit {evidenceDeploymentModeClaimsReportNonOperatorEndpointAuditStatus}/{evidenceDeploymentModeClaimsReportNonOperatorEndpointAuditFailureCount}, framework endpoint boundary audit {evidenceDeploymentModeClaimsReportFrameworkEndpointBoundaryAuditStatus}/{evidenceDeploymentModeClaimsReportFrameworkEndpointBoundaryAuditFailureCount}.",
        ...
        if (adoptionSmokeScenarioCount != 1 ||
            ...
            adoptionSmokeGoldenUseCaseExecutionReportCount != evidenceAdoptionSmokeGoldenUseCaseExecutionReportCount)
        {
            checks.Add(new DoctorCheck(
                DoctorCheckSeverity.Failure,
        ...
        if (sreSliCount != evidenceSreSliCount ||
            ...
            srePendingBaselineRowCount != evidenceSrePendingBaselineRowCount ||
            srePendingBaselineBlockerCount != evidenceSrePendingBaselineBlockerCount ||
            srePendingBaselineEvidenceCount != evidenceSrePendingBaselineEvidenceCount)
        {
            checks.Add(new DoctorCheck(
                DoctorCheckSeverity.Failure,
        ...
        checks.Add(new DoctorCheck(
            sreSeverity,
            "Engine completion scorecard SRE posture",
            $"{sreSliCount} SLIs; target-declared {sreTargetDeclaredCount}, pending stable baselines {srePendingStableBaselineCount}, stable baselines {sreStableBaselineCount}, stable baseline rows {evidenceSreStableBaselineRowCount}, stable baseline measurements {evidenceSreStableBaselineMeasurementCount}, pending baseline rows {srePendingBaselineRowCount}, blockers {srePendingBaselineBlockerCount}, pending evidence {srePendingBaselineEvidenceCount}, guardrail-mapped {sreGuardrailMappedSliCount}, pending guardrail coverage {sreGuardrailPendingSliCount}, guardrail not-applicable {sreGuardrailNotApplicableSliCount}, guardrail references {sreGuardrailReferenceCount}; stable baseline manifest {evidenceSreStableBaselineManifest}.",
        ...
        string ownerName = "Summary")
    {
        ...
        try
        {
            var value = scorecard[propertyName]?.GetValue<bool>();
