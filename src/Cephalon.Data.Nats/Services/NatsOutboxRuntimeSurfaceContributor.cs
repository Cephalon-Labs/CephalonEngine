...
/// <summary>
/// Contributes the NATS outbox producer surface to the active technology runtime catalog.
/// </summary>
internal sealed class NatsOutboxRuntimeSurfaceContributor(IOutboxCatalog catalog) : ITechnologyRuntimeContributor
{
    /// <inheritdoc />
    public TechnologyRuntimeSurface DescribeRuntimeSurface()
    {
        return new TechnologyRuntimeSurface(
            ...
            entries: catalog.GetByProvider(NatsDataOptions.ProviderId)
                .Select(CreateEntry)
                .ToArray());
    }
