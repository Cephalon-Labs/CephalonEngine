...
internal sealed class TraefikTrafficMaterializationRuntimeContributor(
...
{
    private readonly IReadOnlyDictionary<string, TraefikIngressRouteProjection> projectionsByRouteId = projections.Projections;
    ...
    private readonly string materializerId = string.IsNullOrWhiteSpace(options.MaterializerId)
        ? TraefikTrafficMaterializerOptions.DefaultMaterializerId
    ...
    private TechnologyRuntimeEntry CreateEntry(CellTrafficAutomationRuntimeDescriptor automation)
    {
        ...
        return new TechnologyRuntimeEntry(
            ...
            description: $"Traefik IngressRoute materialization for '{automation.DisplayName}'.",
            metadata: metadata);
    }
}
