...
/// <summary>Contributes the OpenSearch inbox store surface to the active technology runtime catalog.</summary>
internal sealed class OpenSearchInboxRuntimeSurfaceContributor(IInboxCatalog catalog) : ITechnologyRuntimeContributor
{
    /// <inheritdoc />
