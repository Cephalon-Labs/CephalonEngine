...
/// <summary>Contributes the OpenSearch outbox producer surface to the active technology runtime catalog.</summary>
internal sealed class OpenSearchOutboxRuntimeSurfaceContributor(IOutboxCatalog catalog) : ITechnologyRuntimeContributor
{
    /// <inheritdoc />
    public TechnologyRuntimeSurface DescribeRuntimeSurface()
    {
        return new TechnologyRuntimeSurface(
            ...
            entries: catalog.GetByProvider(OpenSearchDataOptions.ProviderId)
                .Select(CreateEntry)
                .ToArray());
    }
