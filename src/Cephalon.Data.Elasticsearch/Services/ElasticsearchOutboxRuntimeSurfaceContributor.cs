...
/// <summary>Contributes the Elasticsearch outbox producer surface to the active technology runtime catalog.</summary>
internal sealed class ElasticsearchOutboxRuntimeSurfaceContributor(IOutboxCatalog catalog) : ITechnologyRuntimeContributor
{
    /// <inheritdoc />
    public TechnologyRuntimeSurface DescribeRuntimeSurface()
    {
        return new TechnologyRuntimeSurface(
            ...
            entries: catalog.GetByProvider(ElasticsearchDataOptions.ProviderId)
                .Select(CreateEntry)
                .ToArray());
    }
