...
/// <summary>Contributes the Elasticsearch inbox store surface to the active technology runtime catalog.</summary>
internal sealed class ElasticsearchInboxRuntimeSurfaceContributor(IInboxCatalog catalog) : ITechnologyRuntimeContributor
{
    /// <inheritdoc />
