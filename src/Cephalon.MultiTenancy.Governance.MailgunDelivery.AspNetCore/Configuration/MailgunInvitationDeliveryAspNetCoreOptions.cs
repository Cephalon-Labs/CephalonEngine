...
public sealed class MailgunInvitationDeliveryAspNetCoreOptions
{
    ...
    /// </summary>
    /// <remarks>
    /// The endpoint uses the stable <c>event-data.id</c>-backed observation id generated by the Mailgun mapper. This is
    /// observation-store-backed idempotency, not a durable raw callback inbox or distributed event ledger.
    /// </remarks>
    public bool EnableWebhookEventIdIdempotency { get; set; } = true;
        ...
        string sectionPath = EngineSettings.SectionName)
    {
        ...
        options.EnableWebhookEventIdIdempotency = ParseBoolean(section["EnableWebhookEventIdIdempotency"], options.EnableWebhookEventIdIdempotency);
        return options;
    }
    ...
    internal bool IsWebhookEventIdIdempotencyConfigured() => EnableWebhookEventIdIdempotency;
