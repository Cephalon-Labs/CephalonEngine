...
public sealed class CliApplicationTests
{
    ...
    public async Task RunAsyncDoctorReportsEngineCompletionScorecardSummary()
    {
        ...
        await File.WriteAllTextAsync(scorecardPath, """
            {
              ...
              "Summary": {
                ...
                "SrePendingStableBaselineCount": 3,
                "SreStableBaselineCount": 8,
        ...
        try
        {
            ...
            Assert.Contains("[warn] Engine completion scorecard SRE posture: 11 SLIs; target-declared 11, pending stable baselines 3, stable baselines 8, stable baseline rows 8, stable baseline measurements 10, guardrail-mapped 6, pending guardrail coverage 0, guardrail not-applicable 5, guardrail references 8; stable baseline manifest scripts/sre-stable-baselines.json.", stdout.ToString(), StringComparison.Ordinal);
