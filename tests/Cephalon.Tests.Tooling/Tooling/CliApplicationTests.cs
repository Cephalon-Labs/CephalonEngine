...
public sealed class CliApplicationTests
{
    ...
    public async Task RunAsyncDoctorReportsEngineCompletionScorecardSummary()
    {
        ...
        await File.WriteAllTextAsync(scorecardPath, """
            {
              ...
              "Summary": {
                ...
                "ProviderIntegrationLiveProofCount": 7,
                "ProviderIntegrationCompositionOnlyCount": 25,
                "ProviderIntegrationExternalServiceGateCount": 6,
                "ProviderIntegrationDefaultSkippedCount": 6,
                "ProviderIntegrationRuntimeContractCount": 64,
                "SreSliCount": 11,
        ...
        try
        {
            ...
            Assert.Contains("[warn] Engine completion scorecard provider integration evidence: 32 rows; live proofs 7, composition-only 25, external-service gates 6, default-skipped 6, runtime contracts 64; dependency-health providers 18 from scripts/observability-dependency-health-providers.json schema 1.0.0 (source-derived-provider-family-contract).", stdout.ToString(), StringComparison.Ordinal);
