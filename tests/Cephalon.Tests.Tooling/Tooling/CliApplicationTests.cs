...
public sealed class CliApplicationTests
{
    ...
    public async Task RunAsyncDoctorReportsEngineCompletionScorecardSummary()
    {
        ...
        await File.WriteAllTextAsync(scorecardPath, """
            {
              ...
              "Summary": {
                ...
                "EvidenceSourceReferenceCount": 35,
                ...
                "AdoptionSmokeGoldenUseCaseExecutionReadyCount": 3,
                "AdoptionSmokeGoldenUseCaseExecutionReportCount": 3,
        ...
        try
        {
            ...
            Assert.Contains("[ok] Engine completion scorecard evidence references: 35 repo-local references validated by the published artifact.", stdout.ToString(), StringComparison.Ordinal);
            ...
            Assert.Contains("[ok] Engine completion scorecard adoption smoke evidence: 1 scenario (out-of-tree-generated-app-package-stage, execution-report-ready); runtime probes 6, assertions 7, execution-report fields 9; golden use cases 7, execution-ready 3, reports 3; report artifacts/adoption-smoke/out-of-tree-package-adoption.json schema 1.0.0.", stdout.ToString(), StringComparison.Ordinal);
