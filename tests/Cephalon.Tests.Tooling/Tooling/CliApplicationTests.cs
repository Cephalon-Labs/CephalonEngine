...
public sealed class CliApplicationTests
{
    ...
    public async Task RunAsyncDoctorReportsEngineCompletionScorecardSummary()
    {
        ...
        await File.WriteAllTextAsync(scorecardPath, """
            {
              ...
              "SrePostureEvidence": {
                ...
                "PendingStableBaselineCount": 6,
                "StableBaselineCount": 5,
                "StableBaselineManifest": "scripts/sre-stable-baselines.json",
                "StableBaselineRowCount": 5,
                "StableBaselineMeasurementCount": 7,
              ...
              "Summary": {
                ...
                "SrePendingStableBaselineCount": 6,
                "SreStableBaselineCount": 5,
        ...
        try
        {
            ...
            Assert.Contains("[warn] Engine completion scorecard SRE posture: 11 SLIs; target-declared 11, pending stable baselines 6, stable baselines 5, stable baseline rows 5, stable baseline measurements 7, guardrail-mapped 4, pending guardrail coverage 2, guardrail not-applicable 5, guardrail references 6; stable baseline manifest scripts/sre-stable-baselines.json.", stdout.ToString(), StringComparison.Ordinal);
