...
public sealed class CliApplicationTests
{
    ...
    public async Task RunAsyncDoctorReportsEngineCompletionScorecardSummary()
    {
        ...
        await File.WriteAllTextAsync(scorecardPath, """
            {
              ...
              "Summary": {
                ...
                "SrePendingStableBaselineCount": 4,
                "SreStableBaselineCount": 7,
        ...
        try
        {
            ...
            Assert.Contains("[warn] Engine completion scorecard SRE posture: 11 SLIs; target-declared 11, pending stable baselines 4, stable baselines 7, stable baseline rows 7, stable baseline measurements 9, guardrail-mapped 6, pending guardrail coverage 0, guardrail not-applicable 5, guardrail references 8; stable baseline manifest scripts/sre-stable-baselines.json.", stdout.ToString(), StringComparison.Ordinal);
