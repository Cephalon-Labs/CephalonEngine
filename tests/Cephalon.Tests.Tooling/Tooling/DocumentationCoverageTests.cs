...
public sealed class DocumentationCoverageTests
{
    ...
    public void CompletionScorecardDocsStayAlignedWithDoctorSummary()
    {
        ...
        Assert.Contains("boundary/core route-delegate audit status and failure counts", scorecard, StringComparison.Ordinal);
        ...
        Assert.Contains("boundary/core-route-delegate audit counts", projectMemory, StringComparison.Ordinal);
