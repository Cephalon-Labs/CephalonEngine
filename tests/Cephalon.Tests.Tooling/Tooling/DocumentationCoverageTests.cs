...
public sealed class DocumentationCoverageTests
{
    ...
    public void CompletionScorecardDocsStayAlignedWithDoctorSummary()
    {
        ...
        Assert.Contains("boundary/core/full-common/full-operator route-delegate audit status and failure counts", scorecard, StringComparison.Ordinal);
        ...
        Assert.Contains("boundary/core/full-common/full-operator-route-delegate audit counts", projectMemory, StringComparison.Ordinal);
