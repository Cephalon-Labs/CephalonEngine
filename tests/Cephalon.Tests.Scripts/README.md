...
| --- | --- | --- |
| `scripts/publish-engine-completion-scorecard.ps1` | `publish-engine-completion-scorecard.Tests.ps1` | scorecard JSON/Markdown artifact shape + unsupported status guard + release-validation wiring |
