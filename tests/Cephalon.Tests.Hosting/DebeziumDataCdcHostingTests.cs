...
public sealed class DebeziumDataCdcHostingTests
{
    ...
    public async Task MapCephalonExposesManagedConnectorAutomaticRetryRoutesAfterBoundedBackgroundRetryRuns()
    {
        ...
        try
        {
            ...
            try
            {
                ...
                var hardeningByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/cross-node-idempotency-hardenings/idempotent-safe");
                var hardeningByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/cross-node-idempotency-hardenings/categories/idempotent-safe");
                var hardeningByOwner = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/cross-node-idempotency-hardenings/owners/connect-worker-auto");
                var hardening = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorCrossNodeIdempotencyHardeningStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/cross-node-idempotency-hardening");
                var orchestrationByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/distributed-retry-orchestrations/cooldown");
                var orchestrationByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/distributed-retry-orchestrations/categories/cooldown-window");
                var orchestrationByOwner = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/distributed-retry-orchestrations/owners/connect-worker-auto");
                var orchestration = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorDistributedRetryOrchestrationStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/distributed-retry-orchestration");
                var multiNodeLeaseExecutionByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/multi-node-lease-executions/lease-blocked");
                ...
                var providerOwnedExecutionByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-write-path-executions/provider-owned-executing");
                var providerOwnedExecutionByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-write-path-executions/categories/latest-execution-adapted");
                var providerOwnedExecutionByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-write-path-executions/operations/restart");
                var providerOwnedExecution = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedWritePathExecutionStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-write-path-execution");
                var providerExecutionOrchestrationByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-execution-orchestrations/orchestration-executing");
                var providerExecutionOrchestrationByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-execution-orchestrations/categories/provider-owned-executing");
                var providerExecutionOrchestrationByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-execution-orchestrations/operations/restart");
                var providerExecutionOrchestration = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderExecutionOrchestrationStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-execution-orchestration");
                var providerOwnedControlPlaneOwnershipByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-ownership/ownership-active");
                var providerOwnedControlPlaneOwnershipByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-ownership/categories/provider-owned-executing");
                var providerOwnedControlPlaneOwnershipByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-ownership/operations/restart");
                var providerOwnedControlPlaneOwnership = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneOwnershipStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-control-plane-ownership");
                var providerOwnedControlPlaneMutationReconcileByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-mutation-reconcile/mutation-executing");
                var providerOwnedControlPlaneMutationReconcileByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-owned-control-plane-mutation-reconcile/categories/{CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileCategories.ProviderCommandAdapted}");
                var providerOwnedControlPlaneMutationReconcileByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-mutation-reconcile/operations/restart");
                var providerOwnedControlPlaneMutationReconcile = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-control-plane-mutation-reconcile");
                var providerOwnedControlPlaneProvisioningByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-provisioning/provisioning-executing");
                var providerOwnedControlPlaneProvisioningByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-owned-control-plane-provisioning/categories/{CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneProvisioningCategories.ProviderCommandAdapted}");
                var providerOwnedControlPlaneProvisioningByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-provisioning/operations/restart");
                var providerOwnedControlPlaneProvisioning = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneProvisioningStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-control-plane-provisioning");
                var providerOwnedControlPlaneApplyAndReconcileExecutionByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-apply-and-reconcile-executions/apply-and-reconcile-executing");
                var providerOwnedControlPlaneApplyAndReconcileExecutionByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-owned-control-plane-apply-and-reconcile-executions/categories/{CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneApplyAndReconcileExecutionCategories.ProviderCommandAdapted}");
                var providerOwnedControlPlaneApplyAndReconcileExecutionByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-apply-and-reconcile-executions/operations/restart");
                var providerOwnedControlPlaneApplyAndReconcileExecution = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneApplyAndReconcileExecutionStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-control-plane-apply-and-reconcile-execution");
                var dependencyAwareApplyAndReconcileHardeningByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-dependency-aware-apply-and-reconcile-hardenings/apply-and-reconcile-hardened");
                var dependencyAwareApplyAndReconcileHardeningByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-owned-control-plane-dependency-aware-apply-and-reconcile-hardenings/categories/{CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneDependencyAwareApplyAndReconcileHardeningCategories.CurrentNodeBlocked}");
                var dependencyAwareApplyAndReconcileHardeningByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-dependency-aware-apply-and-reconcile-hardenings/operations/restart");
                var dependencyAwareApplyAndReconcileHardening = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneDependencyAwareApplyAndReconcileHardeningStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-control-plane-dependency-aware-apply-and-reconcile-hardening");
                var dependencyAwareProvisioningAndMutationHardeningByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-dependency-aware-provisioning-and-mutation-hardenings/mutation-hardened");
                ...
                var providerSpecificMaterializerByProviderSurface = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-materializers/provider-surfaces/debezium-kafka-connect-rest");
                ...
                var providerSpecificMaterializerByTransport = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-materializers/transports/http-rest");
                var providerSpecificMaterializerByConnectCluster = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-materializers/connect-clusters/connect-cluster-auto");
                var providerSpecificMaterializerByConnectorClass = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-materializers/connector-classes/io.debezium.connector.postgresql.PostgresConnector");
                var providerSpecificMaterializerBySourceProvider = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-materializers/source-providers/postgresql");
                var providerSpecificMaterializerByConnector = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-specific-control-plane-materializers/connectors/{automaticRetryRuntimeId}");
                var providerSpecificMaterializerByWorker = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-materializers/workers/connect-worker-auto");
                var providerSpecificMaterializerByCurrentNode = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-materializers/current-nodes/false");
                ...
                var providerSpecificTeardownAndMutationExecutionHardeningByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/dependency-ready");
                var providerSpecificTeardownAndMutationExecutionHardeningByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/categories/{CdcCaptureExecutionRuntimeManagedConnectorProviderSpecificControlPlaneDependencyAwareTeardownAndMutationExecutionHardeningCategories.ProviderCommandAdapted}");
                var providerSpecificTeardownAndMutationExecutionHardeningByProvider = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/providers/{DebeziumDataOptions.ProviderId}");
                var providerSpecificTeardownAndMutationExecutionHardeningByProviderSurface = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/provider-surfaces/debezium-kafka-connect-rest");
                var providerSpecificTeardownAndMutationExecutionHardeningByMaterializer = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/materializers/{CdcCaptureExecutionRuntimeManagedConnectorExecutionAdapterIds.DebeziumKafkaConnectRest}");
                var providerSpecificTeardownAndMutationExecutionHardeningByTransport = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/transports/http-rest");
                var providerSpecificTeardownAndMutationExecutionHardeningByConnectCluster = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/connect-clusters/connect-cluster-auto");
                var providerSpecificTeardownAndMutationExecutionHardeningByConnectorClass = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/connector-classes/io.debezium.connector.postgresql.PostgresConnector");
                var providerSpecificTeardownAndMutationExecutionHardeningBySourceProvider = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/source-providers/postgresql");
                var providerSpecificTeardownAndMutationExecutionHardeningByConnector = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/connectors/{automaticRetryRuntimeId}");
                var providerSpecificTeardownAndMutationExecutionHardeningByWorker = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/workers/connect-worker-auto");
                var providerSpecificTeardownAndMutationExecutionHardeningByCurrentNode = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/current-nodes/false");
                var providerSpecificTeardownAndMutationExecutionHardeningByTeardownCurrentNode = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/current-nodes/teardowns/false");
                var providerSpecificTeardownAndMutationExecutionHardeningByMutationCurrentNode = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/current-nodes/mutation-executions/false");
                var providerSpecificTeardownAndMutationExecutionHardeningByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/operations/restart");
                var providerSpecificTeardownAndMutationExecutionHardening = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderSpecificControlPlaneDependencyAwareTeardownAndMutationExecutionHardeningStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardening");
                ...
                Assert.Equal(
                    ...
                    completedRuntime.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.State);
                Assert.Equal(
                ...
                Assert.Equal("connect-worker-auto", completedRuntime.ManagedConnectorProviderSpecificControlPlaneMaterializer.WorkerId);
                Assert.True(completedRuntime.ManagedConnectorProviderSpecificControlPlaneMaterializer.HasWorkerIdentity);
                Assert.Equal(
                    "connect-worker-auto",
                    completedRuntime.ManagedConnectorProviderSpecificControlPlaneDependencyAwareTeardownAndMutationExecutionHardening.WorkerId);
                Assert.True(completedRuntime.ManagedConnectorProviderSpecificControlPlaneDependencyAwareTeardownAndMutationExecutionHardening.HasWorkerIdentity);
                Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardening);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderSpecificControlPlaneDependencyAwareTeardownAndMutationExecutionHardeningStates.DependencyReady,
                    providerSpecificTeardownAndMutationExecutionHardening.State);
                Assert.Equal(
                    DebeziumDataOptions.ProviderId,
                    providerSpecificTeardownAndMutationExecutionHardening.ProviderId);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorExecutionAdapterIds.DebeziumKafkaConnectRest,
                    providerSpecificTeardownAndMutationExecutionHardening.MaterializerId);
                Assert.Equal("connect-worker-auto", providerSpecificTeardownAndMutationExecutionHardening.WorkerId);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByState!.Select(static runtime => runtime.Id).ToArray());
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByCategory!.Select(static runtime => runtime.Id).ToArray());
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByProvider!.Select(static runtime => runtime.Id).ToArray());
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByProviderSurface!.Select(static runtime => runtime.Id).ToArray());
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByMaterializer!.Select(static runtime => runtime.Id).ToArray());
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByTransport!.Select(static runtime => runtime.Id).ToArray());
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByConnector!.Select(static runtime => runtime.Id).ToArray());
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByWorker!.Select(static runtime => runtime.Id).ToArray());
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByOperation!.Select(static runtime => runtime.Id).ToArray());
                ...
                Assert.Contains(
                    ...
                    completedRuntime.ManagedConnectorProviderOwnedControlPlaneOwnership.CategoryIds);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileSources.CommandExecution,
                    completedRuntime.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.SourceId);
                Assert.Contains(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileCategories.MutationExecuting,
                    completedRuntime.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.CategoryIds);
                Assert.Contains(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileCategories.MutationOperation,
                    completedRuntime.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.CategoryIds);
                Assert.Contains(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileCategories.ProviderCommandAdapted,
                    completedRuntime.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.CategoryIds);
                Assert.Contains(
                ...
                Assert.Contains(
                    ...
                    completedRuntime.ManagedConnectorProviderOwnedControlPlaneProvisioning.CategoryIds);
                Assert.NotNull(providerOwnedControlPlaneProvisioningByState);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneProvisioningByState.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerOwnedControlPlaneProvisioningByCategory);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneProvisioningByCategory.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerOwnedControlPlaneProvisioningByOperation);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneProvisioningByOperation.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerOwnedControlPlaneProvisioning);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneProvisioningStates.ProvisioningExecuting,
                    providerOwnedControlPlaneProvisioning.State);
                Assert.NotNull(providerOwnedControlPlaneApplyAndReconcileExecutionByState);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneApplyAndReconcileExecutionByState.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerOwnedControlPlaneApplyAndReconcileExecutionByCategory);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneApplyAndReconcileExecutionByCategory.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerOwnedControlPlaneApplyAndReconcileExecutionByOperation);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneApplyAndReconcileExecutionByOperation.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerOwnedControlPlaneApplyAndReconcileExecution);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneApplyAndReconcileExecutionStates.ApplyAndReconcileExecuting,
                    providerOwnedControlPlaneApplyAndReconcileExecution.State);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneApplyAndReconcileExecutionSources.CommandExecution,
                    providerOwnedControlPlaneApplyAndReconcileExecution.SourceId);
                Assert.False(providerOwnedControlPlaneApplyAndReconcileExecution.CanExecuteProviderOwnedControlPlaneApplyAndReconcileOnCurrentNode);
                Assert.NotNull(dependencyAwareApplyAndReconcileHardeningByState);
                Assert.Equal([automaticRetryRuntimeId], dependencyAwareApplyAndReconcileHardeningByState.Select(static item => item.Id).ToArray());

                Assert.NotNull(dependencyAwareApplyAndReconcileHardeningByCategory);
                Assert.Equal([automaticRetryRuntimeId], dependencyAwareApplyAndReconcileHardeningByCategory.Select(static item => item.Id).ToArray());

                Assert.NotNull(dependencyAwareApplyAndReconcileHardeningByOperation);
                Assert.Equal([automaticRetryRuntimeId], dependencyAwareApplyAndReconcileHardeningByOperation.Select(static item => item.Id).ToArray());

                Assert.NotNull(dependencyAwareApplyAndReconcileHardening);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneDependencyAwareApplyAndReconcileHardeningStates.ApplyAndReconcileHardened,
                    dependencyAwareApplyAndReconcileHardening.State);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneDependencyAwareApplyAndReconcileHardeningSources.ProviderOwnedControlPlaneApplyAndReconcileExecution,
                    dependencyAwareApplyAndReconcileHardening.SourceId);
                Assert.False(dependencyAwareApplyAndReconcileHardening.CanExecuteDependencyAwareApplyAndReconcileOnCurrentNode);
                Assert.NotNull(dependencyAwareProvisioningAndMutationHardeningByState);
                Assert.Equal([automaticRetryRuntimeId], dependencyAwareProvisioningAndMutationHardeningByState.Select(static item => item.Id).ToArray());

                Assert.NotNull(dependencyAwareProvisioningAndMutationHardeningByCategory);
                Assert.Equal([automaticRetryRuntimeId], dependencyAwareProvisioningAndMutationHardeningByCategory.Select(static item => item.Id).ToArray());

                Assert.NotNull(dependencyAwareProvisioningAndMutationHardeningByOperation);
                Assert.Equal([automaticRetryRuntimeId], dependencyAwareProvisioningAndMutationHardeningByOperation.Select(static item => item.Id).ToArray());

                Assert.NotNull(dependencyAwareProvisioningAndMutationHardening);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneDependencyAwareProvisioningAndMutationHardeningStates.MutationHardened,
                    dependencyAwareProvisioningAndMutationHardening.State);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneDependencyAwareProvisioningAndMutationHardeningSources.ProviderOwnedControlPlaneDependencyAwareApplyAndReconcileHardening,
                    dependencyAwareProvisioningAndMutationHardening.SourceId);
                ...
                Assert.NotNull(providerSpecificMaterializerByProviderSurface);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificMaterializerByProviderSurface.Select(static item => item.Id).ToArray());
                ...
                Assert.NotNull(providerSpecificMaterializerByConnectCluster);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificMaterializerByConnectCluster.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificMaterializerByConnectorClass);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificMaterializerByConnectorClass.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificMaterializerBySourceProvider);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificMaterializerBySourceProvider.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificMaterializerByConnector);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificMaterializerByConnector.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificMaterializerByCurrentNode);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificMaterializerByCurrentNode.Select(static item => item.Id).ToArray());
                ...
                Assert.Equal("connect-worker-auto", providerSpecificMaterializer.WorkerId);
                Assert.True(providerSpecificMaterializer.HasWorkerIdentity);
                Assert.False(providerSpecificMaterializer.CanUseProviderSpecificControlPlaneMaterializerOnCurrentNode);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificMaterializerByTransport!.Select(static runtime => runtime.Id).ToArray());
                Assert.Equal([automaticRetryRuntimeId], providerSpecificMaterializerByWorker!.Select(static runtime => runtime.Id).ToArray());
                Assert.Contains(
                ...
                Assert.Contains(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderSpecificControlPlaneMaterializerCategories.WorkerIdentityVisible,
                    providerSpecificMaterializer.CategoryIds);
                Assert.Contains(
                ...
                Assert.False(providerOwnedControlPlaneProvisioning.CanProvisionProviderOwnedControlPlaneOnCurrentNode);

                var schedulerRecoveryHardeningByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/scheduler-recovery-execution-hardenings/execution-hardened");
                var schedulerRecoveryHardeningByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/scheduler-recovery-execution-hardenings/categories/execution-hardened");
                var schedulerRecoveryHardeningByOwner = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/scheduler-recovery-execution-hardenings/owners/connect-worker-auto");
                var schedulerRecoveryHardening = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorSchedulerRecoveryExecutionHardeningStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/scheduler-recovery-execution-hardening");
                ...
                Assert.NotNull(hardeningByState);
                Assert.Equal([automaticRetryRuntimeId], hardeningByState.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(hardeningByCategory);
                Assert.Equal([automaticRetryRuntimeId], hardeningByCategory.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(hardeningByOwner);
                Assert.Equal([automaticRetryRuntimeId], hardeningByOwner.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(hardening);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorCrossNodeIdempotencyHardeningStates.IdempotentSafe,
                    hardening.State);
                Assert.True(hardening.CanExecuteAutomaticRetryOnCurrentNode);

                Assert.NotNull(orchestrationByState);
                Assert.Equal([automaticRetryRuntimeId], orchestrationByState.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(orchestrationByCategory);
                Assert.Equal([automaticRetryRuntimeId], orchestrationByCategory.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(orchestrationByOwner);
                Assert.Equal([automaticRetryRuntimeId], orchestrationByOwner.Select(static runtime => runtime.Id).ToArray());
                ...
                Assert.Equal(
                    ...
                    orchestration.SchedulerId);
                Assert.False(orchestration.CanScheduleAutomaticRetryOnCurrentNode);

                Assert.NotNull(multiNodeLeaseExecutionByState);
                Assert.Equal([automaticRetryRuntimeId], multiNodeLeaseExecutionByState.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(multiNodeLeaseExecutionByCategory);
                Assert.Equal([automaticRetryRuntimeId], multiNodeLeaseExecutionByCategory.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(multiNodeLeaseExecutionByOwner);
                Assert.Equal([automaticRetryRuntimeId], multiNodeLeaseExecutionByOwner.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(multiNodeLeaseExecution);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorMultiNodeLeaseExecutionStates.LeaseBlocked,
                ...
                Assert.NotNull(providerOwnedExecutionByState);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedExecutionByState.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(providerOwnedExecutionByCategory);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedExecutionByCategory.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(providerOwnedExecutionByOperation);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedExecutionByOperation.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(providerOwnedExecution);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedWritePathExecutionStates.ProviderOwnedExecuting,
                    providerOwnedExecution.State);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedWritePathExecutionSources.CommandExecution,
                    providerOwnedExecution.SourceId);
                Assert.False(providerOwnedExecution.CanExecuteProviderOwnedWritePathOnCurrentNode);

                Assert.NotNull(providerExecutionOrchestrationByState);
                Assert.Equal([automaticRetryRuntimeId], providerExecutionOrchestrationByState.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(providerExecutionOrchestrationByCategory);
                Assert.Equal([automaticRetryRuntimeId], providerExecutionOrchestrationByCategory.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(providerExecutionOrchestrationByOperation);
                Assert.Equal([automaticRetryRuntimeId], providerExecutionOrchestrationByOperation.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(providerExecutionOrchestration);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderExecutionOrchestrationStates.OrchestrationExecuting,
                    providerExecutionOrchestration.State);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderExecutionOrchestrationSources.ProviderOwnedWritePathExecution,
                    providerExecutionOrchestration.SourceId);
                Assert.False(providerExecutionOrchestration.CanOrchestrateProviderExecutionOnCurrentNode);
                Assert.NotNull(providerOwnedControlPlaneOwnership);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneOwnershipStates.OwnershipActive,
                    providerOwnedControlPlaneOwnership.State);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneOwnershipSources.ProviderExecutionOrchestration,
                    providerOwnedControlPlaneOwnership.SourceId);
                Assert.False(providerOwnedControlPlaneOwnership.CanExerciseProviderOwnedControlPlaneOnCurrentNode);

                Assert.NotNull(providerOwnedControlPlaneOwnershipByState);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneOwnershipByState.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(providerOwnedControlPlaneOwnershipByCategory);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneOwnershipByCategory.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(providerOwnedControlPlaneOwnershipByOperation);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneOwnershipByOperation.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(providerOwnedControlPlaneMutationReconcileByState);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneMutationReconcileByState.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(providerOwnedControlPlaneMutationReconcileByCategory);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneMutationReconcileByCategory.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(providerOwnedControlPlaneMutationReconcileByOperation);
                Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneMutationReconcileByOperation.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(providerOwnedControlPlaneMutationReconcile);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileStates.MutationExecuting,
                    providerOwnedControlPlaneMutationReconcile.State);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileSources.CommandExecution,
                    providerOwnedControlPlaneMutationReconcile.SourceId);
                Assert.True(providerOwnedControlPlaneMutationReconcile.HasTargetOperation);
                Assert.True(providerOwnedControlPlaneMutationReconcile.IsMutationOperation);
                Assert.False(providerOwnedControlPlaneMutationReconcile.CanMutateOrReconcileOnCurrentNode);

                Assert.NotNull(schedulerRecoveryHardeningByState);
                Assert.Equal([automaticRetryRuntimeId], schedulerRecoveryHardeningByState.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(schedulerRecoveryHardeningByCategory);
                Assert.Equal([automaticRetryRuntimeId], schedulerRecoveryHardeningByCategory.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(schedulerRecoveryHardeningByOwner);
                Assert.Equal([automaticRetryRuntimeId], schedulerRecoveryHardeningByOwner.Select(static runtime => runtime.Id).ToArray());

                Assert.NotNull(schedulerRecoveryHardening);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorSchedulerRecoveryExecutionHardeningStates.ExecutionHardened,
                    schedulerRecoveryHardening.State);
                Assert.Equal(
                    CdcCaptureExecutionRuntimeManagedConnectorSchedulerRecoveryExecutionHardeningSources.CommandExecution,
                    schedulerRecoveryHardening.SourceId);
                Assert.False(schedulerRecoveryHardening.CanExecuteAutomaticRetryOnCurrentNode);
                ...
                item.ManagedConnectorSchedulerRecoveryExecutionHardening.State == CdcCaptureExecutionRuntimeManagedConnectorSchedulerRecoveryExecutionHardeningStates.ExecutionHardened &&
                item.ManagedConnectorProviderOwnedWritePathExecution.State == CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedWritePathExecutionStates.ProviderOwnedExecuting &&
                item.ManagedConnectorProviderExecutionOrchestration.State == CdcCaptureExecutionRuntimeManagedConnectorProviderExecutionOrchestrationStates.OrchestrationExecuting &&
                item.ManagedConnectorProviderOwnedControlPlaneOwnership.State == CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneOwnershipStates.OwnershipActive &&
                item.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.State == CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileStates.MutationExecuting &&
                item.ManagedConnectorProviderOwnedControlPlaneProvisioning.State == CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneProvisioningStates.ProvisioningExecuting &&
                ...
                item.ManagedConnectorProviderSpecificControlPlaneDependencyAwareTeardownAndMutationExecutionHardening.State == CdcCaptureExecutionRuntimeManagedConnectorProviderSpecificControlPlaneDependencyAwareTeardownAndMutationExecutionHardeningStates.DependencyReady &&
    ...
    [Fact]
    public async Task MapCephalonKeepsManagedConnectorAutomaticRetryUncoordinatedWhenCoordinationOwnerDoesNotMatchActiveReporter()
    {
        const string automaticRetryRuntimeId = "inventory-automatic-retry-mismatch-connector";
        const string automaticRetryCaptureId = "inventory-automatic-retry-mismatch-cdc";

        var timeProvider = new MutableTimeProvider(DateTimeOffset.Parse("2026-04-24T03:20:30Z", CultureInfo.InvariantCulture));
        var builder = CreateBuilder(
            options =>
            {
                options.Connectors.Add(CreateConnector(
                    runtimeId: automaticRetryRuntimeId,
                    captureId: automaticRetryCaptureId,
                    displayName: "Inventory Automatic Retry Mismatch Connector",
                    captureDisplayName: "Inventory Automatic Retry Mismatch CDC",
                    captureDescription: "Keeps automatic retry retry-ready but prevents background execution when the local coordination owner does not hold the active reporter lease.",
                    connectClusterId: "connect-cluster-auto-mismatch",
                    connectorClass: "io.debezium.connector.postgresql.PostgresConnector",
                    sourceProviderId: "postgresql",
                    topicPrefix: "inventory-automatic-retry-mismatch",
                    managementMode: "restart",
                    expectedTaskCount: 1,
                    taskIds: ["0"]));
            },
            ...
            dataOptions =>
            {
                dataOptions.EnableManagedConnectorAutomaticRetryExecution = true;
                dataOptions.ManagedConnectorAutomaticRetryPollingIntervalSeconds = 1;
                dataOptions.ManagedConnectorAutomaticRetryCoordinationOwnerId = "connect-worker-owner-a";
            },
            services => services.AddSingleton<ICdcCaptureExecutionRuntimeManagedConnectorExecutionAdapter>(
                new AutomaticRetryTestExecutionAdapter(automaticRetryRuntimeId)));
        ...
        try
        {
            ...
            var reportResponse = await client.PostAsJsonAsync(
                ...
                new[]
                {
                    new CdcCaptureRuntimeObservation(
                        cdcCaptureId: automaticRetryCaptureId,
                        outcome: CdcCaptureRuntimeOutcomes.Captured,
                        observedAtUtc: DateTimeOffset.Parse("2026-04-24T03:20:00Z", CultureInfo.InvariantCulture),
                        reportId: "debezium-report-automatic-retry-mismatch-001",
                        metadata: new Dictionary<string, string>
                        {
                            ["connectorState"] = "RUNNING",
                            ["connectClusterId"] = "connect-cluster-auto-mismatch",
                        ...
                        reporterId: "connect-worker-owner-b")
                });
            reportResponse.EnsureSuccessStatusCode();

            timeProvider.SetUtcNow(DateTimeOffset.Parse("2026-04-24T03:20:31Z", CultureInfo.InvariantCulture));
            var blockedCommandResponse = await client.PostAsJsonAsync(
                $"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/commands/restart",
                new CdcCaptureExecutionRuntimeManagedConnectorCommandExecutionRequest
                {
            ...
            timeProvider.SetUtcNow(DateTimeOffset.Parse("2026-04-24T03:21:10Z", CultureInfo.InvariantCulture));

            var runtime = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}");
            ...
            var distributedLease = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorDistributedRetryLeaseStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/distributed-retry-lease");
            var hardeningByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/cross-node-idempotency-hardenings/stale-owner-risk");
            var hardeningByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/cross-node-idempotency-hardenings/categories/stale-owner-risk");
            var hardeningByOwner = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/cross-node-idempotency-hardenings/owners/connect-worker-owner-a");
            var hardening = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorCrossNodeIdempotencyHardeningStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/cross-node-idempotency-hardening");
            var orchestrationByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/distributed-retry-orchestrations/blocked");
            var orchestrationByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/distributed-retry-orchestrations/categories/owner-mismatch");
            var orchestrationByOwner = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/distributed-retry-orchestrations/owners/connect-worker-owner-a");
            var orchestration = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorDistributedRetryOrchestrationStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/distributed-retry-orchestration");
            var multiNodeLeaseExecutionByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/multi-node-lease-executions/stale-lease-risk");
            ...
            var durableSharedScheduler = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorDurableSharedSchedulerOrchestrationStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/durable-shared-scheduler-orchestration");
            var providerOwnedExecutionByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-write-path-executions/provider-owned-risk");
            var providerOwnedExecutionByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-write-path-executions/categories/provider-owned-risk");
            var providerOwnedExecutionByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-write-path-executions/operations/restart");
            var providerOwnedExecution = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedWritePathExecutionStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-write-path-execution");
            var providerExecutionOrchestrationByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-execution-orchestrations/orchestration-risk");
            var providerExecutionOrchestrationByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-execution-orchestrations/categories/recovery-blocked");
            var providerExecutionOrchestrationByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-execution-orchestrations/operations/restart");
            var providerExecutionOrchestration = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderExecutionOrchestrationStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-execution-orchestration");
            var providerOwnedControlPlaneOwnershipByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-ownership/ownership-risk");
            var providerOwnedControlPlaneOwnershipByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-ownership/categories/recovery-blocked");
            var providerOwnedControlPlaneOwnershipByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-ownership/operations/restart");
            var providerOwnedControlPlaneOwnership = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneOwnershipStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-control-plane-ownership");
            var providerOwnedControlPlaneMutationReconcileByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-mutation-reconcile/mutation-risk");
            var providerOwnedControlPlaneMutationReconcileByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-owned-control-plane-mutation-reconcile/categories/{CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileCategories.ProviderCommandBlocked}");
            var providerOwnedControlPlaneMutationReconcileByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-mutation-reconcile/operations/restart");
            var providerOwnedControlPlaneMutationReconcile = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-control-plane-mutation-reconcile");
            var providerOwnedControlPlaneProvisioningByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-provisioning/provisioning-risk");
            var providerOwnedControlPlaneProvisioningByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-owned-control-plane-provisioning/categories/{CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneProvisioningCategories.ProvisioningRisk}");
            var providerOwnedControlPlaneProvisioningByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-provisioning/operations/restart");
            var providerOwnedControlPlaneProvisioning = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneProvisioningStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-control-plane-provisioning");
            var dependencyAwareApplyAndReconcileHardeningByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-dependency-aware-apply-and-reconcile-hardenings/dependency-risk");
            var dependencyAwareApplyAndReconcileHardeningByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-owned-control-plane-dependency-aware-apply-and-reconcile-hardenings/categories/{CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneDependencyAwareApplyAndReconcileHardeningCategories.ProviderCommandBlocked}");
            var dependencyAwareApplyAndReconcileHardeningByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-dependency-aware-apply-and-reconcile-hardenings/operations/restart");
            var dependencyAwareApplyAndReconcileHardening = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneDependencyAwareApplyAndReconcileHardeningStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-control-plane-dependency-aware-apply-and-reconcile-hardening");
            var dependencyAwareProvisioningAndMutationHardeningByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-dependency-aware-provisioning-and-mutation-hardenings/dependency-risk");
            var dependencyAwareProvisioningAndMutationHardeningByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-owned-control-plane-dependency-aware-provisioning-and-mutation-hardenings/categories/{CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneDependencyAwareProvisioningAndMutationHardeningCategories.ProviderCommandBlocked}");
            var dependencyAwareProvisioningAndMutationHardeningByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-dependency-aware-provisioning-and-mutation-hardenings/operations/restart");
            var dependencyAwareProvisioningAndMutationHardening = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneDependencyAwareProvisioningAndMutationHardeningStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-control-plane-dependency-aware-provisioning-and-mutation-hardening");
            var providerSpecificTeardownAndMutationExecutionHardeningByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/dependency-risk");
            var providerSpecificTeardownAndMutationExecutionHardeningByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/categories/{CdcCaptureExecutionRuntimeManagedConnectorProviderSpecificControlPlaneDependencyAwareTeardownAndMutationExecutionHardeningCategories.ProviderCommandBlocked}");
            var providerSpecificTeardownAndMutationExecutionHardeningByProvider = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/providers/{DebeziumDataOptions.ProviderId}");
            var providerSpecificTeardownAndMutationExecutionHardeningByProviderSurface = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/provider-surfaces/debezium-kafka-connect-rest");
            var providerSpecificTeardownAndMutationExecutionHardeningByMaterializer = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/materializers/{CdcCaptureExecutionRuntimeManagedConnectorExecutionAdapterIds.DebeziumKafkaConnectRest}");
            var providerSpecificTeardownAndMutationExecutionHardeningByTransport = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/transports/http-rest");
            var providerSpecificTeardownAndMutationExecutionHardeningByConnectCluster = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/connect-clusters/connect-cluster-auto-mismatch");
            var providerSpecificTeardownAndMutationExecutionHardeningByConnectorClass = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/connector-classes/io.debezium.connector.postgresql.PostgresConnector");
            var providerSpecificTeardownAndMutationExecutionHardeningBySourceProvider = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/source-providers/postgresql");
            var providerSpecificTeardownAndMutationExecutionHardeningByConnector = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/connectors/{automaticRetryRuntimeId}");
            var providerSpecificTeardownAndMutationExecutionHardeningByWorker = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/workers/connect-worker-owner-b");
            var providerSpecificTeardownAndMutationExecutionHardeningByCurrentNode = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/current-nodes/false");
            var providerSpecificTeardownAndMutationExecutionHardeningByTeardownCurrentNode = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/current-nodes/teardowns/false");
            var providerSpecificTeardownAndMutationExecutionHardeningByMutationCurrentNode = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/current-nodes/mutation-executions/false");
            var providerSpecificTeardownAndMutationExecutionHardeningByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-specific-control-plane-dependency-aware-teardown-and-mutation-execution-hardenings/operations/restart");
            ...
            var commandHistory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorCommandExecutionResult[]>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/command-executions");
            var snapshot = await client.GetFromJsonAsync<RuntimeIntrospectionSnapshot>("/engine/snapshot");
            var refreshedRuntime = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}");
            ...
            Assert.False(runtime.ManagedConnectorSchedulerRecoveryExecutionHardening.CanExecuteAutomaticRetryOnCurrentNode);
            Assert.False(runtime.ManagedConnectorProviderOwnedWritePathExecution.CanExecuteProviderOwnedWritePathOnCurrentNode);
            Assert.False(runtime.ManagedConnectorProviderExecutionOrchestration.CanOrchestrateProviderExecutionOnCurrentNode);
            Assert.False(runtime.ManagedConnectorProviderOwnedControlPlaneOwnership.CanExerciseProviderOwnedControlPlaneOnCurrentNode);
            Assert.False(runtime.ManagedConnectorProviderOwnedControlPlaneProvisioning.CanProvisionProviderOwnedControlPlaneOnCurrentNode);
            Assert.False(runtime.ManagedConnectorProviderOwnedControlPlaneDependencyAwareApplyAndReconcileHardening.CanExecuteDependencyAwareApplyAndReconcileOnCurrentNode);
            Assert.False(runtime.ManagedConnectorProviderOwnedControlPlaneDependencyAwareProvisioningAndMutationHardening.CanExecuteDependencyAwareProvisioningAndMutationOnCurrentNode);
            Assert.False(runtime.ManagedConnectorProviderOwnedControlPlaneDependencyAwareProvisioningAndMutationHardening.CanExecuteDependencyAwareProvisioningOnCurrentNode);
            Assert.False(runtime.ManagedConnectorProviderOwnedControlPlaneDependencyAwareProvisioningAndMutationHardening.CanExecuteDependencyAwareMutationOnCurrentNode);
            ...
            Assert.Contains(
                CdcCaptureExecutionRuntimeManagedConnectorCrossNodeIdempotencyHardeningCategories.StaleOwnerRisk,
                runtime.ManagedConnectorCrossNodeIdempotencyHardening.CategoryIds);
            Assert.Contains(
                CdcCaptureExecutionRuntimeManagedConnectorMultiNodeLeaseExecutionCategories.StaleLeaseRisk,
                runtime.ManagedConnectorMultiNodeLeaseExecution.CategoryIds);
            Assert.Contains(
                CdcCaptureExecutionRuntimeManagedConnectorMultiNodeLeaseExecutionCategories.OwnerMismatch,
                runtime.ManagedConnectorMultiNodeLeaseExecution.CategoryIds);
            Assert.Contains(
                CdcCaptureExecutionRuntimeManagedConnectorMultiNodeLeaseExecutionCategories.CurrentNodeBlocked,
                runtime.ManagedConnectorMultiNodeLeaseExecution.CategoryIds);
            ...
            Assert.Contains(
                ...
                runtime.ManagedConnectorSchedulerRecoveryExecutionHardening.CategoryIds);
            Assert.Contains(
                CdcCaptureExecutionRuntimeManagedConnectorSchedulerRecoveryExecutionHardeningCategories.OwnerMismatch,
                runtime.ManagedConnectorSchedulerRecoveryExecutionHardening.CategoryIds);
            Assert.Contains(
                CdcCaptureExecutionRuntimeManagedConnectorSchedulerRecoveryExecutionHardeningCategories.SchedulerConflicted,
                runtime.ManagedConnectorSchedulerRecoveryExecutionHardening.CategoryIds);
            Assert.Equal(
                CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedWritePathExecutionSources.CommandExecution,
                runtime.ManagedConnectorProviderOwnedWritePathExecution.SourceId);
            Assert.Contains(
                CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedWritePathExecutionCategories.ProviderOwnedRisk,
                runtime.ManagedConnectorProviderOwnedWritePathExecution.CategoryIds);
            Assert.Contains(
            ...
            Assert.Contains(
                ...
                runtime.ManagedConnectorProviderOwnedControlPlaneOwnership.CategoryIds);
            Assert.Contains(
            ...
            Assert.Equal(
                CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileSources.CommandExecution,
                runtime.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.SourceId);
            Assert.Equal(
                CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneProvisioningSources.ProviderOwnedControlPlaneMutationReconcile,
                runtime.ManagedConnectorProviderOwnedControlPlaneProvisioning.SourceId);
            Assert.Contains(
                CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileCategories.MutationRisk,
                runtime.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.CategoryIds);
            Assert.Contains(
                CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileCategories.MutationOperation,
                runtime.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.CategoryIds);
            Assert.Contains(
                CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileCategories.ProviderCommandBlocked,
                runtime.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.CategoryIds);
            Assert.Contains(
                CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneProvisioningCategories.ProvisioningRisk,
                runtime.ManagedConnectorProviderOwnedControlPlaneProvisioning.CategoryIds);
            Assert.Contains(
            ...
            var schedulerRecoveryHardeningByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/scheduler-recovery-execution-hardenings/recovery-blocked");
            var schedulerRecoveryHardeningByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/scheduler-recovery-execution-hardenings/categories/recovery-blocked");
            var schedulerRecoveryHardeningByOwner = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/scheduler-recovery-execution-hardenings/owners/connect-worker-owner-a");
            var schedulerRecoveryHardening = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorSchedulerRecoveryExecutionHardeningStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/scheduler-recovery-execution-hardening");
            ...
            Assert.NotNull(coordinationByCategory);
            Assert.Equal([automaticRetryRuntimeId], coordinationByCategory.Select(static item => item.Id).ToArray());
            ...
            Assert.NotNull(hardeningByState);
            Assert.Equal([automaticRetryRuntimeId], hardeningByState.Select(static item => item.Id).ToArray());

            Assert.NotNull(hardeningByCategory);
            Assert.Equal([automaticRetryRuntimeId], hardeningByCategory.Select(static item => item.Id).ToArray());

            Assert.NotNull(hardeningByOwner);
            Assert.Equal([automaticRetryRuntimeId], hardeningByOwner.Select(static item => item.Id).ToArray());

            Assert.NotNull(hardening);
            Assert.Equal(
                CdcCaptureExecutionRuntimeManagedConnectorCrossNodeIdempotencyHardeningStates.StaleOwnerRisk,
                hardening.State);
            Assert.False(hardening.CanExecuteAutomaticRetryOnCurrentNode);

            Assert.NotNull(orchestrationByState);
            Assert.Equal([automaticRetryRuntimeId], orchestrationByState.Select(static item => item.Id).ToArray());

            Assert.NotNull(orchestrationByCategory);
            Assert.Equal([automaticRetryRuntimeId], orchestrationByCategory.Select(static item => item.Id).ToArray());

            Assert.NotNull(orchestrationByOwner);
            Assert.Equal([automaticRetryRuntimeId], orchestrationByOwner.Select(static item => item.Id).ToArray());
            ...
            Assert.NotNull(multiNodeLeaseExecutionByState);
            Assert.Equal([automaticRetryRuntimeId], multiNodeLeaseExecutionByState.Select(static item => item.Id).ToArray());

            Assert.NotNull(multiNodeLeaseExecutionByCategory);
            Assert.Equal([automaticRetryRuntimeId], multiNodeLeaseExecutionByCategory.Select(static item => item.Id).ToArray());

            Assert.NotNull(multiNodeLeaseExecutionByOwner);
            Assert.Equal([automaticRetryRuntimeId], multiNodeLeaseExecutionByOwner.Select(static item => item.Id).ToArray());
            ...
            Assert.NotNull(providerOwnedExecutionByState);
            Assert.Equal([automaticRetryRuntimeId], providerOwnedExecutionByState.Select(static item => item.Id).ToArray());

            Assert.NotNull(providerOwnedExecutionByCategory);
            Assert.Equal([automaticRetryRuntimeId], providerOwnedExecutionByCategory.Select(static item => item.Id).ToArray());

            Assert.NotNull(providerOwnedExecutionByOperation);
            Assert.Equal([automaticRetryRuntimeId], providerOwnedExecutionByOperation.Select(static item => item.Id).ToArray());
            ...
            Assert.NotNull(providerExecutionOrchestrationByState);
            Assert.Equal([automaticRetryRuntimeId], providerExecutionOrchestrationByState.Select(static item => item.Id).ToArray());

            Assert.NotNull(providerExecutionOrchestrationByCategory);
            Assert.Equal([automaticRetryRuntimeId], providerExecutionOrchestrationByCategory.Select(static item => item.Id).ToArray());

            Assert.NotNull(providerExecutionOrchestrationByOperation);
            Assert.Equal([automaticRetryRuntimeId], providerExecutionOrchestrationByOperation.Select(static item => item.Id).ToArray());
            ...
            Assert.NotNull(providerOwnedControlPlaneOwnershipByState);
            Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneOwnershipByState.Select(static item => item.Id).ToArray());

            Assert.NotNull(providerOwnedControlPlaneOwnershipByCategory);
            Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneOwnershipByCategory.Select(static item => item.Id).ToArray());

            Assert.NotNull(providerOwnedControlPlaneOwnershipByOperation);
            Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneOwnershipByOperation.Select(static item => item.Id).ToArray());

            Assert.NotNull(providerOwnedControlPlaneMutationReconcileByState);
            Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneMutationReconcileByState.Select(static item => item.Id).ToArray());

            Assert.NotNull(providerOwnedControlPlaneMutationReconcileByCategory);
            Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneMutationReconcileByCategory.Select(static item => item.Id).ToArray());

            Assert.NotNull(providerOwnedControlPlaneMutationReconcileByOperation);
            Assert.Equal([automaticRetryRuntimeId], providerOwnedControlPlaneMutationReconcileByOperation.Select(static item => item.Id).ToArray());
            ...
            Assert.Equal(
                ...
                providerOwnedControlPlaneProvisioning.SourceId);
            Assert.False(providerOwnedControlPlaneProvisioning.CanProvisionProviderOwnedControlPlaneOnCurrentNode);
            var providerOwnedControlPlaneApplyAndReconcileExecutionByState = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>("/engine/cdc-capture-runtimes/provider-owned-control-plane-apply-and-reconcile-executions/apply-and-reconcile-risk");
            var providerOwnedControlPlaneApplyAndReconcileExecutionByCategory = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-owned-control-plane-apply-and-reconcile-executions/categories/{CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneApplyAndReconcileExecutionCategories.ProviderCommandBlocked}");
            var providerOwnedControlPlaneApplyAndReconcileExecutionByOperation = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeDescriptor[]>($"/engine/cdc-capture-runtimes/provider-owned-control-plane-apply-and-reconcile-executions/operations/{providerOwnedControlPlaneProvisioning.OperationId}");
            var providerOwnedControlPlaneApplyAndReconcileExecution = await client.GetFromJsonAsync<CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneApplyAndReconcileExecutionStatus>($"/engine/cdc-capture-runtimes/{automaticRetryRuntimeId}/provider-owned-control-plane-apply-and-reconcile-execution");
            ...
            Assert.Contains(
                ...
                dependencyAwareApplyAndReconcileHardening.CategoryIds);
            Assert.False(dependencyAwareApplyAndReconcileHardening.CanExecuteDependencyAwareApplyAndReconcileOnCurrentNode);
            Assert.NotNull(dependencyAwareProvisioningAndMutationHardeningByState);
            Assert.Equal([automaticRetryRuntimeId], dependencyAwareProvisioningAndMutationHardeningByState.Select(static item => item.Id).ToArray());
            ...
            Assert.Contains(
                ...
                dependencyAwareProvisioningAndMutationHardening.CategoryIds);
            Assert.False(dependencyAwareProvisioningAndMutationHardening.CanExecuteDependencyAwareProvisioningAndMutationOnCurrentNode);
            Assert.False(dependencyAwareProvisioningAndMutationHardening.CanExecuteDependencyAwareProvisioningOnCurrentNode);
            Assert.False(dependencyAwareProvisioningAndMutationHardening.CanExecuteDependencyAwareMutationOnCurrentNode);

            Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByState);
            Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByState.Select(static item => item.Id).ToArray());

            Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByCategory);
            Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByCategory.Select(static item => item.Id).ToArray());

            Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByProvider);
            Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByProvider.Select(static item => item.Id).ToArray());

            Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByProviderSurface);
            Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByProviderSurface.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByMaterializer);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByMaterializer.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByConnectCluster);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByConnectCluster.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByConnectorClass);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByConnectorClass.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningBySourceProvider);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningBySourceProvider.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByTransport);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByTransport.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByConnector);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByConnector.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByWorker);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByWorker.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByCurrentNode);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByCurrentNode.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByTeardownCurrentNode);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByTeardownCurrentNode.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByMutationCurrentNode);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByMutationCurrentNode.Select(static item => item.Id).ToArray());

                Assert.NotNull(providerSpecificTeardownAndMutationExecutionHardeningByOperation);
                Assert.Equal([automaticRetryRuntimeId], providerSpecificTeardownAndMutationExecutionHardeningByOperation.Select(static item => item.Id).ToArray());
            ...
            Assert.Equal(
                ...
                providerSpecificTeardownAndMutationExecutionHardening.SourceId);
            Assert.Equal(DebeziumDataOptions.ProviderId, providerSpecificTeardownAndMutationExecutionHardening.ProviderId);
            Assert.Equal(
                CdcCaptureExecutionRuntimeManagedConnectorExecutionAdapterIds.DebeziumKafkaConnectRest,
                providerSpecificTeardownAndMutationExecutionHardening.MaterializerId);
            Assert.Equal("debezium-kafka-connect-rest", providerSpecificTeardownAndMutationExecutionHardening.ProviderSurfaceId);
            Assert.Equal(automaticRetryRuntimeId, providerSpecificTeardownAndMutationExecutionHardening.ConnectorId);
            Assert.Equal("connect-worker-owner-b", providerSpecificTeardownAndMutationExecutionHardening.WorkerId);
            Assert.True(providerSpecificTeardownAndMutationExecutionHardening.HasWorkerIdentity);
            Assert.Contains(
                ...
                providerSpecificTeardownAndMutationExecutionHardening.CategoryIds);
            Assert.Contains(
                ...
                providerSpecificTeardownAndMutationExecutionHardening.CategoryIds);
            Assert.False(providerSpecificTeardownAndMutationExecutionHardening.CanExecuteDependencyAwareTeardownAndMutationExecutionOnCurrentNode);
            Assert.False(providerSpecificTeardownAndMutationExecutionHardening.CanExecuteDependencyAwareMutationExecutionOnCurrentNode);

            Assert.NotNull(schedulerRecoveryHardeningByState);
            Assert.Equal([automaticRetryRuntimeId], schedulerRecoveryHardeningByState.Select(static item => item.Id).ToArray());

            Assert.NotNull(schedulerRecoveryHardeningByCategory);
            Assert.Equal([automaticRetryRuntimeId], schedulerRecoveryHardeningByCategory.Select(static item => item.Id).ToArray());

            Assert.NotNull(schedulerRecoveryHardeningByOwner);
            Assert.Equal([automaticRetryRuntimeId], schedulerRecoveryHardeningByOwner.Select(static item => item.Id).ToArray());
            ...
            Assert.Equal(
                CdcCaptureExecutionRuntimeManagedConnectorCommandExecutionInvocationSources.OperatorRequest,
                commandHistory[0].InvocationSourceId);
            Assert.True(commandHistory[0].IsOperatorRequestInvocation);
            Assert.Equal(CdcCaptureExecutionRuntimeManagedConnectorCommandExecutionStates.Blocked, commandHistory[0].State);
            ...
            Assert.Equal(
                CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileStates.MutationRisk,
                refreshedRuntime.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.State);
            Assert.False(refreshedRuntime.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.CanMutateOrReconcileOnCurrentNode);
            Assert.Equal(
                CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneProvisioningStates.ProvisioningRisk,
            ...
            Assert.Contains(snapshot.CdcCaptureExecutionRuntimes, item => item.Id == automaticRetryRuntimeId &&
                ...
                item.ManagedConnectorSchedulerRecoveryExecutionHardening.State == CdcCaptureExecutionRuntimeManagedConnectorSchedulerRecoveryExecutionHardeningStates.RecoveryBlocked &&
                item.ManagedConnectorProviderOwnedWritePathExecution.State == CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedWritePathExecutionStates.ProviderOwnedRisk &&
                item.ManagedConnectorProviderExecutionOrchestration.State == CdcCaptureExecutionRuntimeManagedConnectorProviderExecutionOrchestrationStates.OrchestrationRisk &&
                item.ManagedConnectorProviderOwnedControlPlaneOwnership.State == CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneOwnershipStates.OwnershipRisk &&
                item.ManagedConnectorProviderOwnedControlPlaneMutationReconcile.State == CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneMutationReconcileStates.MutationRisk &&
                item.ManagedConnectorProviderOwnedControlPlaneProvisioning.State == CdcCaptureExecutionRuntimeManagedConnectorProviderOwnedControlPlaneProvisioningStates.ProvisioningRisk &&
                ...
                item.ManagedConnectorProviderSpecificControlPlaneDependencyAwareTeardownAndMutationExecutionHardening.State == CdcCaptureExecutionRuntimeManagedConnectorProviderSpecificControlPlaneDependencyAwareTeardownAndMutationExecutionHardeningStates.DependencyRisk &&
