...
public sealed class MongoDbDataCdcPackTests : IAsyncLifetime
{
    ...
    [Fact]
    public async Task AddMongoDbData_ProviderNativeChangeStreamRuntimeStagesPublicationsAndPersistsCheckpoint()
    {
        ...
        services.AddCephalon(engine =>
        {
            ...
            engine.AddMongoDbData(ConnectionString, "cephalon-cdc-test", configure: options =>
            {
                ...
                capture.ResourceIds.Add("cephalon-cdc-test.orders");
        ...
        TimeSpan timeout)
    {
        ...
        throw new TimeoutException("Timed out while waiting for the expected MongoDB CDC condition.");
    }
