...
public sealed class EngineBuilderTests
{
    ...
    {
        var olderBrokerInboundConsumptionReport = EventSubscriptionBrokerInboundConsumptionMetadata.CreateReport(
            new EventSubscriptionExecutionReport(
                subscriptionId: "alpha-subscription",
                outcome: EventSubscriptionExecutionOutcomes.Succeeded,
                observedAtUtc: new DateTimeOffset(2026, 05, 13, 13, 0, 0, TimeSpan.Zero),
            ...
            acknowledgementId: "alpha-acknowledgement",
            leaseId: "alpha-consumer-lease",
            retryPolicy: "alpha-retry-policy",
            poisonMessageHandling: "alpha-poison-policy",
            offsetCheckpointId: "alpha-offset-checkpoint");
        var newerBrokerInboundConsumptionReport = EventSubscriptionBrokerInboundConsumptionMetadata.CreateReport(
            new EventSubscriptionExecutionReport(
                subscriptionId: "beta-subscription",
                outcome: EventSubscriptionExecutionOutcomes.Succeeded,
                observedAtUtc: new DateTimeOffset(2026, 05, 13, 13, 30, 0, TimeSpan.Zero),
            ...
            acknowledgementId: "beta-acknowledgement",
            leaseId: "beta-consumer-lease",
            retryPolicy: "beta-retry-policy",
            poisonMessageHandling: "beta-poison-policy",
            offsetCheckpointId: "beta-offset-checkpoint");
        var newerPartialBrokerInboundConsumptionReport = new EventSubscriptionExecutionReport(
            subscriptionId: "gamma-subscription",
            outcome: EventSubscriptionExecutionOutcomes.Succeeded,
            observedAtUtc: new DateTimeOffset(2026, 05, 13, 14, 0, 0, TimeSpan.Zero),
        ...
        var services = new ServiceCollection();
        services.AddSingleton<IEventSubscriptionRuntimeCatalog>(new TestEventSubscriptionRuntimeCatalog(
            CreateSubscriptionRuntimeState(olderBrokerInboundConsumptionReport),
            CreateSubscriptionRuntimeState(newerBrokerInboundConsumptionReport),
            CreateSubscriptionRuntimeState(newerPartialBrokerInboundConsumptionReport)));
        services.AddCephalon(engine =>
        {
            engine.UseSettings(new EngineSettings(
                blueprint: "Microservice",
            ...
            engine.AddEventing(options =>
            {
                ...
                options.Subscriptions.Add(new EventSubscriptionDescriptor(
                    id: "alpha-subscription",
                    displayName: "Alpha Subscription",
                    description: "Older broker inbound consumption proof.",
                    channelId: "contracts",
                ...
                options.Subscriptions.Add(new EventSubscriptionDescriptor(
                    id: "beta-subscription",
                    displayName: "Beta Subscription",
                    description: "Newer broker inbound consumption proof.",
                    channelId: "contracts",
                ...
                options.Subscriptions.Add(new EventSubscriptionDescriptor(
                    id: "gamma-subscription",
                    displayName: "Gamma Subscription",
                    description: "Newer partial broker inbound consumption report.",
                    channelId: "contracts",
        ...
        Assert.Contains("inboundAcknowledgementId=beta-acknowledgement", evidence, StringComparison.Ordinal);
        ...
        Assert.Contains("poisonMessageHandling=beta-poison-policy", evidence, StringComparison.Ordinal);
        ...
        Assert.Contains("lastObservedAtUtc=2026-05-13T13:30:00.0000000+00:00", evidence, StringComparison.Ordinal);
        Assert.Contains("wolverineRequired=false", evidence, StringComparison.Ordinal);
        Assert.DoesNotContain("consumerOffsetCheckpointId=alpha-offset-checkpoint", evidence, StringComparison.Ordinal);
