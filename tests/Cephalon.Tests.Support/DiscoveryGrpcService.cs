...
internal sealed class DiscoveryGrpcService : DiscoveryService.DiscoveryServiceBase
{
    private readonly TestGreetingComposer composer;

    public DiscoveryGrpcService(TestGreetingComposer composer)
    {
