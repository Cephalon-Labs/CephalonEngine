...
- `src/Cephalon.MultiTenancy.Governance`: tenant-membership, tenant-invitation, declared tenant-domain ownership, approval/remediation action decision, in-process action workflow, and opt-in durable membership/invitation/action-store governance companion package
