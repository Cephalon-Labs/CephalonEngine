...
- optional multi-tenancy companion packages for tenant resolution, ambient tenant context, tenant-membership governance, tenant-invitation validation, declared domain ownership, and approval/remediation action workflows
...
- `src/Cephalon.MultiTenancy.Governance`: tenant-membership, tenant-invitation, declared tenant-domain ownership, approval/remediation action decision, in-process action workflow, and opt-in durable membership/action-store governance companion package
